...
### Split View
  ...
  Some users will need easy access to multiple Nightscout views at the same time. We have a special view for this case, accessed on /split path on your Nightscout URL. The view supports showing 2, 3, 4 and 8 way split window, where the content for the screen can be loaded from multiple Nightscout instances. To set the URLs from which the content is loaded, set:
