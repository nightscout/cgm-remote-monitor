...
describe('reports', function ( ) {
  ...
  it ('should produce some html', function (done) {
    ...
    client.init(function afterInit ( ) {
      ...
      result.indexOf('td class="tdborder" style="background-color:#8f8"><strong>Normal: </strong></td><td class="tdborder">52.9%</td><td class="tdborder">5</td>').should.be.greaterThan(-1); // distribution
