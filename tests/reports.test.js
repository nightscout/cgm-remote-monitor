...
describe('reports', function ( ) {
  ...
  it ('should produce some html', function (done) {
    ...
    result.indexOf('<td>Correction Bolus</td><td align="center">250 (Sensor)</td><td align="center">0.75</td><td align="center"></td><td align="center"></td><td>Mom </td><td></td>').should.be.greaterThan(-1); //treatments
