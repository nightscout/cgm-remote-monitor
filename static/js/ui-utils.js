...
$('#useDefaults').click(function(event) {
    ...
    var settings = ['units', 'alarmUrgentHigh', 'alarmHigh', 'alarmLow', 'alarmUrgentLow', 'alarmTimeAgoWarn', 'alarmTimeAgoUrgent', 'nightMode', 'showRawbg', 'customTitle', 'theme', 'timeFormat'];
