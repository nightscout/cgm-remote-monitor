...
function configure(app, wares, ctx) {
  ...
  * Make sure this works with just an id on the end. Ex: remotecommands/12345
  * Check that appropriate not found error returned when not found.
  ...
  */
  ...
  function config_authed(app, api, wares, ctx) {
    ...
    /*
    * Updates: The resulting url should be in the Location header field per https://stackoverflow.com/questions/797834/should-a-restful-put-operation-return-something
    */
    ...
    */
    ...
    function delete_records(req, res, next) {
      var query = req.query;
      if (!query.count) {
        query.count = 10 //TODO: This would unexpectedly only delete the first 10?
      }
