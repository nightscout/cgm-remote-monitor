...
function configure(app, wares, ctx) {
  ...
  function ifModifiedSinceCTX(req, res, next) {
    ...
    if (!_isNil(lastEntry)) {
      ...
      if (lastEntryDate !== null) res.setHeader('Last-Modified', lastEntryDate.toUTCString());
    }
    ...
    if ((lastEntryDate !== null) && (lastEntryDate.getTime() <= new Date(ifModifiedSince).getTime())) {
