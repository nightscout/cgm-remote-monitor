...
function configure (app, wares, ctx) {
  ...
  var express = require('express'),
    ...
    function ifModifiedSinceCTX (req, res, next) {
      ...
      var lastEntryDate = new Date(_.last(ctx.ddata.sgvs).mills);
    ...
    /**
      ...
      */
    api.get('/entries/current', ifModifiedSinceCTX, function(req, res, next) {
      //assume sgv
    ...
    /**
      ...
      */
    api.get('/entries/:spec', ifModifiedSinceCTX, function(req, res, next) {
