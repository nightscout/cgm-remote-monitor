...
function configure (app, wares, ctx, env) {
    ...
    ctx.googleHome.configureIntentHandler('CurrentMetric', function (callback, slots, sbx) {
    ...
    function handleIntent(body, next) {
      ...
      var metric = body.result.parameters ? body.result.parameters.metric : null;
      var handler = ctx.googleHome.getIntentHandler(intentName, metric);
      if (handler) {
