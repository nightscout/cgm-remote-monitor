    ...
    if (slots) {
      ...
      switch (intentName) {
        ...
        case 'MetricReportNow':
          metricName = 'action_current';
          break;
      }

      var slotStatus = _.get(slots, metricName+'.resolutions.resolutionsPerAuthority[0].status.code');
      var slotName = _.get(slots, metricName+'.resolutions.resolutionsPerAuthority[0].values[0].value.name');
