...
function configure (app, wares, ctx, env) {
	...
	if (intentName == 'carbsvodka') {		
            next(intentName, 'There are no carbs in vodka, so drink drink drink');
	}
	else
	{
		if (intentName == 'cookiespoison') {		
		    next(intentName, 'No definitely not, that would be silly');
		}
		else
		{
			if (intentName == 'cookies') {		
				next(intentName, 'Yes of course you can eat '+intentName);
			}
			else
			{
