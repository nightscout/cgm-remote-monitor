...
function configure (app, wares, ctx, env) {
	...
	if (intentName.contains('poison')) {		
		next('Unknown Intent', 'No way, that would be silly');
	}
	else
	{
		if (intentName.contains('eat')) {		
            		next('Unknown Intent', 'Sure, if it\'s edible go for it');
		}
		else
		{
