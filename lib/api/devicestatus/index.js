...
function configure (app, wares, ctx) {
  ...
  function config_authed (app, api, wares, ctx) {
    ...
    api.delete('/devicestatus/:spec', ctx.authorization.isPermitted('api:devicestatus:delete'), function(req, res, next) {
        ...
        if (isId(req.params.spec)) {
            ...
            req.query.find = req.query.find || req.params.spec;

            if (req.query.find === '*') {
                // delete the whole collection
                delete req.query.find;
            }
        }
        next();
    }, delete_records);
