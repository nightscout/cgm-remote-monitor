...
function init (client, d3, $) {
  ...
  chart.update = function update(init) {
    ...
    console.log('chartContainer.height', chartContainer.outerHeight());
    var top = (client.bottomOfPills() + 5);
    let h = $(window).height() - top - PADDING_BOTTOM;
    let h2 = $(window).height() - chartContainerRect.top - PADDING_BOTTOM;
    console.log('calculated height', chartContainerRect.top, top, h, h2);
    console.log('chartContainerRect.height', chartContainerRect.height);
