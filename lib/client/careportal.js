...
function init (client, $) {
  ...
  function prepareData() {
    ...
    if ($('#othertime').is(':checked')) {
      data.eventTime = client.utils.mergeInputTime($('#eventTimeValue').val(), $('#eventDateValue').val());
    }
  ...
  $('#treatmentDrawerToggle').click(function (event) {
    client.browserUtils.toggleDrawer('#treatmentDrawer', initTreatmentDrawer);
    event.preventDefault();
  });
  ...
  $('.eventinput').focus(function (event) {
    ...
    var moment = client.utils.mergeInputTime(eventTime.val(), eventDate.val());
  ...
  .change(function (event) {
    ...
    eventTime.val(moment.format('HH:mm'));
    eventDate.val(moment.format('YYYY-MM-DD'));
    $(this).attr('oldminutes', moment.minutes());
    $(this).attr('oldhours', moment.hours());
    event.preventDefault();
  });
