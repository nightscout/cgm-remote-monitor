...
function init (client, $) {
  ...
  careportal.filterInputs = function filterInputs (event) {
    ...
    var nutrition = inputMatrix[eventType]['carbs'];// || inputMatrix[eventType]['protein'] || inputMatrix[eventType]['fat'] ;
    $('#nutritionContainer').css('display',displayType(nutrition));
    //$('#nutritionContainer').css('display','none');
