...
function init (client, $) {
  ...
  careportal.filterInputs = function filterInputs (event) {
    ...
    // nutrition on if any of 'Given' are on
    $('#nutrition').css('display', displayType(inputMatrix[eventType]['carbs'] || inputMatrix[eventType]['protein'] || inputMatrix[eventType]['fat']));
