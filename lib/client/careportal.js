...
function init (client, $) {
  ...
  careportal.filterInputs = function filterInputs (event) {
    ...
    var reasons = inputMatrix[String(eventType)]['reasons'];
    $('#reasonLabel').css('display', displayType(reasons && reasons.length > 0));
    $('#targets').css('display', displayType(inputMatrix[String(eventType)]['targets']));

    $('#bg').css('display', displayType(inputMatrix[String(eventType)]['bg']));
    $('#insulinGivenLabel').css('display', displayType(inputMatrix[String(eventType)]['insulin']));
    $('#carbsGivenLabel').css('display', displayType(inputMatrix[String(eventType)]['carbs']));
    $('#proteinGivenLabel').css('display', displayType(inputMatrix[String(eventType)]['protein']));
    $('#fatGivenLabel').css('display', displayType(inputMatrix[String(eventType)]['fat']));
    $('#durationLabel').css('display', displayType(inputMatrix[String(eventType)]['duration']));
    $('#percentLabel').css('display', displayType(inputMatrix[String(eventType)]['percent'] && $('#absolute').val() === ''));
    $('#absoluteLabel').css('display', displayType(inputMatrix[String(eventType)]['absolute'] && $('#percent').val() === ''));
    $('#profileLabel').css('display', displayType(inputMatrix[String(eventType)]['profile']));
    $('#preBolusLabel').css('display', displayType(inputMatrix[String(eventType)]['prebolus']));
    $('#insulinSplitLabel').css('display', displayType(inputMatrix[String(eventType)]['split']));
    ...
    resetIfHidden(inputMatrix[String(eventType)]['insulin'], '#insulinGiven');
    resetIfHidden(inputMatrix[String(eventType)]['carbs'], '#carbsGiven');
    resetIfHidden(inputMatrix[String(eventType)]['protein'], '#proteinGiven');
    resetIfHidden(inputMatrix[String(eventType)]['fat'], '#fatGiven');
    resetIfHidden(inputMatrix[String(eventType)]['duration'], '#duration');
    resetIfHidden(inputMatrix[String(eventType)]['absolute'], '#absolute');
    resetIfHidden(inputMatrix[String(eventType)]['percent'], '#percent');
    resetIfHidden(inputMatrix[String(eventType)]['prebolus'], '#preBolus');
    resetIfHidden(inputMatrix[String(eventType)]['split'], '#insulinSplitNow');
    resetIfHidden(inputMatrix[String(eventType)]['split'], '#insulinSplitExt');
