...
function init (client, $) {
  ...
  careportal.filterInputs = function filterInputs ( event ) {
    var inputMatrix = {
      '<none>':            { bg: true,  insulin: false, carbs: true,  prebolus: true,  duration: false }
    , 'BG Check':          { bg: true,  insulin: false, carbs: false, prebolus: false, duration: false }
    , 'Snack Bolus':       { bg: true,  insulin: true,  carbs: true,  prebolus: true,  duration: false }
    , 'Meal Bolus':        { bg: true,  insulin: true,  carbs: true,  prebolus: true,  duration: false }
    , 'Correction Bolus':  { bg: true,  insulin: true,  carbs: false, prebolus: false, duration: false }
    , 'Carb Correction':   { bg: true,  insulin: false, carbs: true,  prebolus: false, duration: false }
    , 'Announcement':      { bg: false, insulin: false, carbs: false, prebolus: false, duration: false }
    , 'Note':              { bg: true,  insulin: false, carbs: false, prebolus: false, duration: true  }
    , 'Question':          { bg: true,  insulin: false, carbs: false, prebolus: false, duration: false }
    , 'Exercise':          { bg: false, insulin: false, carbs: false, prebolus: false, duration: true  }
    , 'Site Change':       { bg: false, insulin: false, carbs: false, prebolus: false, duration: false }
    , 'Sensor Start':      { bg: false, insulin: false, carbs: false, prebolus: false, duration: false }
    , 'Sensor Change':     { bg: false, insulin: false, carbs: false, prebolus: false, duration: false }
    , 'Insulin Change':    { bg: false, insulin: false, carbs: false, prebolus: false, duration: false }
    , 'D.A.D. Alert':      { bg: true,  insulin: false, carbs: false, prebolus: false, duration: false }
    };
