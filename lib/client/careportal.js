...
function init (client, $) {
  ...
  careportal.filterInputs = function filterInputs ( event ) {
    ...
    , 'Announcement':      { bg: false, insulin: false, carbs: false, prebolus: false, duration: false, percent: false, absolute: false  }
    ...
    , 'Site Change':       { bg: false, insulin: false, carbs: false, prebolus: false, duration: false, percent: false, absolute: false  }
