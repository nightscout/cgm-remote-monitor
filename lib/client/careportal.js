...
function init (client, $) {
  ...
  function postComboBolus(data) {
    var treatmentdata = _.cloneDeep(data);
    treatmentdata.enteredinsulin = data.insulin;
    treatmentdata.insulin = data.insulin * data.splitNow / 100;
    ...
    var basaldata = {};
    basaldata.eventType = 'Temp Basal';
    basaldata.notes = data.notes;
    basaldata.enteredBy = data.enteredBy;
    basaldata.duration = data.duration;
    basaldata.eventTime = data.eventTime;
    basaldata.relative = data.insulin * data.splitExt / 100 / data.duration * 60;
