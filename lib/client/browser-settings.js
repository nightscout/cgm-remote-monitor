...
function init (serverSettings, plugins) {
  var settings = require('../settings')();

  try {
    settings.eachSetting(function setEachBrowserSetting (name) {
      return storage.get(name) || serverSettings.settings[name];
    });
...
function loadForm (settings, plugins) {
