...
function init (client, serverSettings, $) {
  ...
  try {
    ...
    console.log(client);
    console.log('Showing client.profilefunctions');
    console.log(client.profilefunctions);
    console.log('Showing high target');
    console.log(client.profilefunctions.getHighBGTarget());
