  ...
  function loadForm () {
    ...
    var token = client.browserUtils.queryParms().token;            
                if (token) {            
                  ...
                  $('#admintoolslink').attr("href", $('#admintoolslink').attr("href") + '?token=' + token);
                  $('#bgclocklink').attr("href", $('#bgclocklink').attr("href") + '?token=' + token);   
                  $('#clocklink').attr("href", $('#clocklink').attr("href") + '?token=' + token);
                  $('#clockcolorlink').attr("href", $('#clockcolorlink').attr("href") + '?token=' + token);
                }
  }
