...
function init (client, serverSettings, $) {
  ...
  function updateBolusRender () {
    ...
    var allRenderOverOptions = [1, 0.5, 0.1];
    ...
    $('#bolusRenderOver').append('<option value="0">All</option>');
    ...
    $('#bolusRenderOver').append('<option value="' + Number.MAX_SAFE_INTEGER + '">None</option>');
    $('#bolusRenderOver').val(String(bolusSettings.renderOver || 0));
