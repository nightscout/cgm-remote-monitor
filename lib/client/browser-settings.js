...
function init (client, serverSettings, $) {
  ...
  try {
    ...
    console.log('Showing client.ddata');
    console.log(client.ddata);
    console.log('Showing client.ddata.profile high target');
    console.log(client.ddata.profile.getHighBGTarget());
