...
function init (client, serverSettings, $) {
  ...
  function loadForm ( ) {
    ...
    $('#focus-range-hours-1').val(settings.focusRangeHours1);
    $('#focus-range-hours-2').val(settings.focusRangeHours2);
    $('#focus-range-hours-3').val(settings.focusRangeHours3);
    $('#focus-range-hours-4').val(settings.focusRangeHours4);
    $('#focus-range-hours-5').val(settings.focusRangeHours5);

    if(settings.defaultFocusRangeHours === 'focusRangeHours1') {
      $('#focus-range-hours-1').prop('checked', true);
    } else if(settings.defaultFocusRangeHours === 'focusRangeHours2') {
      $('#focus-range-hours-2').prop('checked', true);
    } else if(settings.defaultFocusRangeHours === 'focusRangeHours3') {
      $('#focus-range-hours-3').prop('checked', true);
    } else if(settings.defaultFocusRangeHours === 'focusRangeHours4') {
      $('#focus-range-hours-4').prop('checked', true);
    } else if(settings.defaultFocusRangeHours === 'focusRangeHours5') {
      $('#focus-range-hours-5').prop('checked', true);
    }
  ...
  function wireForm ( ) {
    ...
    $('#save').click(function(event) {
      ...
      storeInBrowser({
        ...
        defaultFocusRangeHours: $('input:radio[name=focus-hours-range]:checked').val(),
        focusRangeHours1: parseInt($('focus-range-hours-1').val()) || 2,
        focusRangeHours2: parseInt($('focus-range-hours-2').val()) || 3,
        focusRangeHours3: parseInt($('focus-range-hours-3').val()) || 6,
        focusRangeHours4: parseInt($('focus-range-hours-4').val()) || 12,
        focusRangeHours5: parseInt($('focus-range-hours-5').val()) || 24,
