...
// added wrong opacity for circles	  .style('opacity', 0.4)
...
// added wrong opacity for circles i.e.   .style('opacity', 0.4)
...
// make text look smaller and normal
//      .style('font-size', 15)
//      .style('font-weight', 'bold')
      .style('font-size', 15)
      .style('font-weight', 'normal')
// added opacity attribute to reduce impact of profile switches to graphs
      .style('opacity', 0.3)
      .attr('fill', '#0099ff')
