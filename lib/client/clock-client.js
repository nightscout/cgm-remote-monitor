...
client.render = function render(xhr) {
	...
	// Insert the BG value text, converting to mmol first if necessary
	$('#bgnow').html(if (window.serverSettings.settings.units == 'mmol') { Nightscout.units.mgdlToMMOL(rec.sgv); } else { rec.sgv }));
