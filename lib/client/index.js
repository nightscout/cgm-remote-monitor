  ...
  function getTimeFormat (isForScale, compact) {
    ...
    if (client.settings.timeFormat === 24) {
      if (client.settings.showSeconds) {
        timeFormat = isForScale ? FORMAT_TIME_24_SCALE_SECONDS : FORMAT_TIME_24_SECONDS;
      } else {
        timeFormat = isForScale ? FORMAT_TIME_24_SCALE : FORMAT_TIME_24;
      }
    } else {
      if (client.settings.showSeconds) {
        timeFormat = isForScale ? FORMAT_TIME_12_SCALE_SECONDS : (compact ? FORMAT_TIME_12_COMPACT_SECONDS : FORMAT_TIME_12_SECONDS);
      } else {
