...
var d3 = (global && global.d3) || require('../d3.mjs');
...
client.init = function init (callback) {
  ...
  function retry () {
    window.setTimeout(function retryInit () {
...
client.load = function load (serverSettings, callback) {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  /* global io */
  // Close polling before navigation aborts its requests (notably in WebKit).
  client.socket = socket = io.connect({ transports: ["polling"], closeOnBeforeunload: true });
  client.alarmSocket = alarmSocket = io.connect("/alarm", { multiplex: true, transports: ["polling"], closeOnBeforeunload: true });
