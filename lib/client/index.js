...
client.load = function load (serverSettings, callback) {
  ...
  function brushed () {
    ...
    var brushedRange = d3.event && d3.event.selection || null;

    if (brushedRange) {
      var rangeWidth=brushExtent[1]-brushExtent[0]

      brushExtent[0] = brushedRange[0] * rangeWidth + brushExtent[0]
      brushExtent[1] = brushedRange[1] * rangeWidth + brushExtent[0]
    }
