...
client.init = function init(serverSettings, plugins) {
  ...
  client.bottomOfPills = function bottomOfPills ( ) {
    var bottomOfMinorPills = minorPills.offset().top + minorPills.height();
    var bottomOfStatusPills = statusPills.offset().top + statusPills.height();
...
// clears the current user brush and resets to the current real time data
  ...
  function brushed ( ) {
    ...
    $('#chartContainer').css('top', client.bottomOfPills() + 'px');
