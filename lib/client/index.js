...
client.init = function init(serverSettings, plugins) {
  ...
  //chart = client.chart = require('./chart')(client);
  var renderer = client.renderer = require('./renderer')(client);
...
// clears the current user brush and resets to the current real time data
  ...
  function inRetroMode() {
    if (!chart || !chart.brush) {
      return false;
    }

    var time = chart.brush.extent()[1].getTime();
  ...
  function brushed(skipTimer) {
    ...
    client.focus.select('.open-top')
      ...
      .attr('y1', chart.yScale(scaleBg(30)))
      .attr('x2', chart.xScale2(chart.brush.extent()[1]))
      .attr('y2', chart.yScale(scaleBg(30)));
...
// called for initial update and updates for resize
  var updateChart = _.debounce(function debouncedUpdateChart(init) {
    ...
    if ((client.prevChartWidth !== chartWidth) || (client.prevChartHeight !== chartHeight)) {
      ...
      if (init) {
        ...
        client.context.append('g')
          .attr('class', 'x brush')
          .call(d3.svg.brush().x(chart.xScale2).on('brush', brushed))
          .selectAll('rect')
          .attr('y', focusHeight)
        ...
        client.focus.append('line')
          .attr('class', 'now-line')
          .attr('x1', chart.xScale(new Date(now)))
          .attr('y1', chart.yScale(scaleBg(30)))
          .attr('x2', chart.xScale(new Date(now)))
          .attr('y2', chart.yScale(scaleBg(420)))
        ...
        client.focus.append('line')
          ...
          .attr('y1', chart.yScale(scaleBg(client.settings.thresholds.bgHigh)))
          .attr('x2', chart.xScale(dataRange[1]))
          .attr('y2', chart.yScale(scaleBg(client.settings.thresholds.bgHigh)))
        ...
        client.focus.append('line')
          ...
          .attr('x1', chart.xScale(dataRange[0]))
          .attr('y1', chart.yScale(scaleBg(client.settings.thresholds.bgTargetTop)))
          .attr('x2', chart.xScale(dataRange[1]))
          .attr('y2', chart.yScale(scaleBg(client.settings.thresholds.bgTargetTop)))
          .style('stroke-dasharray', ('3, 3'))
          .attr('stroke', 'grey');
        ...
        client.focus.append('line')
          ...
          .attr('x1', chart.xScale(dataRange[0]))
          .attr('y1', chart.yScale(scaleBg(client.settings.thresholds.bgTargetBottom)))
          .attr('x2', chart.xScale(dataRange[1]))
          .attr('y2', chart.yScale(scaleBg(client.settings.thresholds.bgTargetBottom)))
          .style('stroke-dasharray', ('3, 3'))
          .attr('stroke', 'grey');
        ...
        client.focus.append('line')
          .attr('class', 'low-line')
          .attr('x1', chart.xScale(dataRange[0]))
          .attr('y1', chart.yScale(scaleBg(client.settings.thresholds.bgLow)))
          .attr('x2', chart.xScale(dataRange[1]))
          .attr('y2', chart.yScale(scaleBg(client.settings.thresholds.bgLow)))
          .style('stroke-dasharray', ('1, 6'))
          .attr('stroke', '#777');
        ...
        client.context.append('line')
          .attr('class', 'high-line')
          .attr('x1', chart.xScale(dataRange[0]))
          .attr('y1', chart.yScale2(scaleBg(client.settings.thresholds.bgTargetTop)))
          .attr('x2', chart.xScale(dataRange[1]))
          .attr('y2', chart.yScale2(scaleBg(client.settings.thresholds.bgTargetTop)))
          .style('stroke-dasharray', ('3, 3'))
          .attr('stroke', 'grey');
        ...
        client.context.append('line')
          .attr('class', 'low-line')
          .attr('x1', chart.xScale(dataRange[0]))
          .attr('y1', chart.yScale2(scaleBg(client.settings.thresholds.bgTargetBottom)))
          .attr('x2', chart.xScale(dataRange[1]))
          .attr('y2', chart.yScale2(scaleBg(client.settings.thresholds.bgTargetBottom)))
          .style('stroke-dasharray', ('3, 3'))
          .attr('stroke', 'grey');
    ...
    client.context.select('.x').call(chart.xAxis2);
