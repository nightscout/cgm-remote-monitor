  ...
  client.init(function loaded () {
    ...
    function loadData (day, options, callback) {
      ...
      var cgmData = []
        ...
        , treatmentData = []
        , calData = [];
      var startOfDay = client.sbx.data.profile.parseInTimezone(day);
      var from = startOfDay.valueOf();
      var to = startOfDay.clone().add(1, 'day').valueOf();
      ...
      function loadCGMData () {
        ...
        return $.ajax('/api/v1/entries.json' + query, {
          ...
          , success: function(xhr) {
            ...
            data.sgv = uniqSgv(data.sgv, function(d) {
    ...
    function processData (data, day, options, callback) {
      ...
      // Cover the complete local day, including 23/25-hour DST transitions.
      var startOfDay = client.sbx.data.profile.parseInTimezone(day);
      var from = startOfDay.toDate();
      var to = startOfDay.clone().add(1, 'day').toDate();
