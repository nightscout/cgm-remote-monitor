...
//      if (sig) {
//        snoozeLink = '\nSnooze(30m): ' +
//          env.baseUrl + '/api/v1/notifications/snooze?level=1&lengthMills=' +
//          TIME_30_MINS_MS + '&t=' + now + '&sig=' + sig;
//      }
    }
    var event = {
      name: notify.eventName || notify.plugin.name
      , level: ctx.notifications.levels.toLowerCase(notify.level)
      , value1: notify.title
      , value2: notify.message && '\n' + notify.message
      //snooze links seem to be getting called
      //, value3: snoozeLink
    };
