...
module.exports = function (entry_coll_fn, settings_coll_fn) {
...
function verifyAuthorization(req, res) {
   ...
   var isAuthorized = (typeof api_secret === "undefined" || secret != api_secret);
    if (isAuthorized) {
        sendJSONError(res, HTTP_UNAUTHORIZED, 'Unauthorized', 'API_SECRET Request Header is incorect or missing.');
    }
