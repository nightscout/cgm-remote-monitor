          ...
          if (!err && results) {
            ...
            results.forEach(function (element) {
              if (element) {
                if (element.mbg) {
                  mbgs.push({
                    mgdl: element.mbg, mills: element.date, device: element.device
                  });
                } else if (element.sgv) {
                  sgvs.push({
                    mgdl: element.sgv, mills: element.date, device: element.device, direction: element.direction, filtered: element.filtered, unfiltered: element.unfiltered, noise: element.noise, rssi: element.rssi
                  });
                }
              }
            });
