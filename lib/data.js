...
function init(env, ctx) {
  ...
  data.update = function update(done) {
    ...
    function loadComplete (err) {
      ...
      updateTreatmentDisplayBGs(data, env, function treatmentUpdateComplete (err, result) {
        done(err, result)
      });
    }
...
function updateTreatmentDisplayBGs (data, env, callback) {
  function updateTreatmentBG(treatment) {

    function mgdlByTime() {

      console.info('>>>>trying to find mgdl for mills: ' + treatment.mills);
