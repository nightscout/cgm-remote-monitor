...
function init(env, ctx) {
  ...
  data.calculateDelta = function calculateDelta(lastData) {
    ...
    delta.lastUpdated = data.lastUpdated;
    ...
    for (var array in compressibleArrays) {
      ...
      if (data.hasOwnProperty(a)) {
        ...
        var deltaData = nsArrayDiff(lastData[a], data[a]);
    ...
    for (var object in skippableObjects) {
      ...
      if (data.hasOwnProperty(o)) {
        if (JSON.stringify(data[o]) != JSON.stringify(lastData[o])) {
