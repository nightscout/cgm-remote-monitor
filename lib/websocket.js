...
// list of alarms with their thresholds
  ...
  function calculateDelta(d) {
	...
	var sgvDelta = patientData.sgvs.diff(d.sgvs);
    ...
    var treatmentDelta = patientData.treatments.diff(d.treatments);
    ...
    var mbgsDelta = patientData.mbgs.diff(d.mbgs);
    ...
    var calsDelta = patientData.cals.diff(d.cals);
