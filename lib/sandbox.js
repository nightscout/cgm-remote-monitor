...
function init ( ) {
  ...
  sbx.buildBGNowLine = function buildBGNowLine (displaySGV) {
    ...
    var trend = sbx.properties.trend && sbx.properties.trend.label;
    if (trend) {
      line += ' ' + trend;
    }
  ...
  sbx.prepareDefaultLines = function prepareDefaultLines(displaySGV) {
  ...
  sbx.buildDefaultMessage = function buildDefaultMessage(displaySGV) {
    return sbx.prepareDefaultLines(displaySGV).join('\n');
  };
