...
var messages = new Map([
  ...
  ['Loop remote carbs failed. Incorrect carbs entry: ',
    'Loop remote carbs failed: invalid carbs entry. Check the carbohydrate amount entered.'],
  ['Loop remote bolus failed. Incorrect bolus entry: ',
    'Loop remote bolus failed: invalid bolus entry. Check the bolus amount entered.'],
