...
function storage (collection, ctx) {
  ...
  function removeOld (date, fn) {
    ...
    for (year=2015; year < endDate.year(); ++year) {
      ...
      retVal = api( ).remove(filter, fn);
    }

    console.info('Finished deleting devicestatus old years');
    ...
    console.info('Finished deleting devicestatus old months');
    ...
    console.info('Finished deleting devicestatus old days');
