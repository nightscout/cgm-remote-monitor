...
function init (env, ctx) {
  ...
  loop.sendNotification = function sendNotification (data, remoteAddress, completion) {
    ...
    if (data.eventType === 'Temporary Override Cancel') {
      ...
      //For version 2.0, sending all the data in the Notification.
      payload = Object.assign({}, data, payload)
      alert  = "Remote Command Recieved";
    } else {
    ...
    //We may need this, although you can't seem to set new properties on this.
