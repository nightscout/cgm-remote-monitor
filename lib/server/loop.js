...
function init (env, ctx) {
  ...
  loop.sendNotification = function sendNotification (data, remoteAddress, completion) {
    ...
    if (data.eventType === 'Temporary Override Cancel') {
      ...
      //payload["carbs-entry"] = data.carbsValue;
      //payload["absorption-time"] = data.absorptionTime;
      //alert  = "Remote Carbohydrates Entry: "+data.value+" grams\n";
      //alert += "Absorption Time: "+data.absorptionTime" hours."";
