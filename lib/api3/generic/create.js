  ...
  self.operation = function operation (req, res) {
    ...
    function replace (doc, storageDoc, authorization) {
      ...
      try {
        ...
        col.authBuilder.authorizerFor('api:' + col.colName + ':update')(req, res, async function authorized () {
    ...
    col.authBuilder.authorizerFor('api:' + col.colName + ':create')(req, res, function authorized (authorization) {
