...
function UpdateOperation (ctx, env, app, col) {
  ...
  self.operation = function operation (req, res) {
    ...
    function insert (identifier, doc, authorization) {
      ...
      col.authBuilder.authorizerFor('api:' + col.colName + ':create')(req, res, async function authorized () {
        try {
    ...
    col.authBuilder.authorizerFor('api:' + col.colName + ':update')(req, res, function authorized (authorization) {
