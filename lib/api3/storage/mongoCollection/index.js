...
function MongoCollection (ctx, env, colName) {
  ...
  self.findEveryForm = (...args) => find.findEveryForm(self.col, ...args);
  ...
  self.updateEveryForm = (...args) => modify.updateEveryForm(self.col, ...args);

  self.deleteEveryForm = (...args) => modify.deleteEveryForm(self.col, ...args);
