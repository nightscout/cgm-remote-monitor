...
hourlystats.report = function report_hourlystats (datastorage, sorteddaystoshow, options) {
  ...
  // Modern D3 v7 per-hour box-and-whisker / candlestick chart.
  // Each hour: box from Q1 to Q3, median line, whiskers to the std-dev
  // range (avg-dev .. avg+dev) -- the same statistics the old Flot
  // candlestick rendered. Replaces the legacy Flot candlestick plugin.
