...
profiles.report = function report_profiles (datastorage) {
  ...
  function recordChange (event) {
    ...
    var div = $('<div style="max-height:700px; overflow-y:auto; display: inline-block; max-width: 700px; overflow-x:auto; ">')
  ...
  function displayRecord (record, name, startdate) {
    ...
    table.append($('<tr>').append($('<td>').append('<b>Startdate</b>:<br>' + startdate)));
    ...
    table.append($('<tr>').append($('<td>').append('<b>' + translate('I:C') + '</b>:&nbsp' + '<br>' + displayRanges(record.carbratio))));
    table.append($('<tr>').append($('<td>').append('<b>' + translate('ISF') + '</b>:&nbsp' + '<br>' + displayRanges(record.sens))));
    table.append($('<tr>').append($('<td>').append('<b>' + translate('Basal rates [unit/h]') + '</b>:&nbsp' + '<br>' + displayRanges(record.basal))));
    table.append($('<tr>').append($('<td>').append('<b>' + translate('Target BG') + '</b>:&nbsp' + '<br>' + displayRanges(record.target_low, record.target_high))));
