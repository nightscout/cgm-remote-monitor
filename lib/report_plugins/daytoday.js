...
daytoday.html = function html(client) {
  ...
  var ret =
    ...
    + translate('Display') + ': '
    + '<input type="checkbox" id="rp_optionsinsulin" checked="checked"><label for="rp_optionsinsulin" style="color:blue;opacity:0.5">'+translate('Insulin')+'</label>'
    + '<input type="checkbox" id="rp_optionscarbs" checked="checked"><label for="rp_optionscarbs" style="color:red;opacity:0.5">'+translate('Carbs')+'</label>'
    + '<input type="checkbox" id="rp_optionsbasal" checked="checked"><label for="rp_optionsbasal" style="color:#0099ff;opacity:0.5">'+translate('Basal rate')+'</label>'
    + '<input type="checkbox" id="rp_optionsnotes" checked="checked"><label for="rp_optionsnotes">'+translate('Notes')+'</label>'
    + '<input type="checkbox" id="rp_optionsfood" checked="checked"><label for="rp_optionsfood">'+translate('Food')+'</label>'
    + '<input type="checkbox" id="rp_optionsraw"><label for="rp_optionsraw" style="color:gray;opacity:1">'+translate('Raw')+'</label>'
    + '<input type="checkbox" id="rp_optionsiob"><label for="rp_optionsiob" style="color:blue;opacity:0.5">'+translate('IOB')+'</label>'
    + '<input type="checkbox" id="rp_optionscob"><label for="rp_optionscob" tyle="color:red;opacity:0.5">'+translate('COB')+'</label>'
    + '<input type="checkbox" id="rp_optionsopenaps"><label for="rp_optionsopenaps" style="color:sienna;opacity:0.5">'+translate('OpenAPS')+'</label>'
    + '<input type="checkbox" id="rp_optionsdistribution"><label for="rp_optionsdistribution" style="color:blue;opacity:0.5">'+translate('Insulin distribution')+'</label>'
    ...
    + '<br>'
    + translate('Scale') + ': '
    + '<input type="radio" name="rp_scale" id="rp_linear" checked="checked">'
    + '<label for="rp_linear">' + translate('Linear') + '</label>'
    + '<input type="radio" name="rp_scale" id="rp_log">'
    + '<label for="rp_log">' + translate('Logarithmic') + '</label>'
    + '<br>'
