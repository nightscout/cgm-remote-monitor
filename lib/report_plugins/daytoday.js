      ...
      sel.attr('cx', function(d) {
        ...
        .on('mouseover', function(d) {
          if (options.openAps && d.openaps) {
            ...
            var text = '<b>BG:</b> ' + bg +
              ', ' + client.utils.escapeHtml(d.openaps.suggested.reason) +
              (d.openaps.suggested.mealAssist ? ' <b>Meal Assist:</b> ' + client.utils.escapeHtml(d.openaps.suggested.mealAssist) : '');
