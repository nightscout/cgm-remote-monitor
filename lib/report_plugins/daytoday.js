...
//        text = sign + '    ' + client.profilefunctions.profileSwitchName(treatment.cutting) + '    ' + '►►►' + '    ' + client.profilefunctions.profileSwitchName(treatment.profile) + '    ' + sign;
        text = sign + '►' + client.profilefunctions.profileSwitchName(treatment.profile).substr( 1, client.profilefunctions.profileSwitchName(treatment.profile).indexOf(')') + 1 ) + sign;
      } else {
