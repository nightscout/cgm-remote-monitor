...
//        text = sign + '    ' + client.profilefunctions.profileSwitchName(treatment.cutting) + '    ' + '►►►' + '    ' + client.profilefunctions.profileSwitchName(treatment.profile) + '    ' + sign;
        text = sign + '►' + client.profilefunctions.profileSwitchName(treatment.profile).subst(1,15) + sign;
      } else {
//        text = sign + '    ' + client.profilefunctions.profileSwitchName(treatment.profile) + '    ' + sign;
//        text = sign + ' ' + client.profilefunctions.profileSwitchName(treatment.profile) + sign;
        text = sign + ' ' + client.profilefunctions.profileSwitchName(treatment.profile).substr(1,15) + sign;
      }
      context.append('text')
        .style('font-size', 12)
        .style('font-weight', 'bold')
