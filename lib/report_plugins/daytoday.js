...
//        text = sign + '    ' + client.profilefunctions.profileSwitchName(treatment.cutting) + '    ' + '►►►' + '    ' + client.profilefunctions.profileSwitchName(treatment.profile) + '    ' + sign;
        text = sign + '►' + client.profilefunctions.profileSwitchName(treatment.cutting).substr(0,7) + sign;
      } else {
//        text = sign + '    ' + client.profilefunctions.profileSwitchName(treatment.profile) + '    ' + sign;
        text = sign + '▬' + client.profilefunctions.profileSwitchName(treatment.profile).substr(0,7) + sign;
      }
      context.append('text')
        .style('font-size', 12)
//        .style('font-weight', 'bold')
