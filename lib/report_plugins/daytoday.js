...
//            .text((t.percent ? (t.percent > 0 ? '+' : '') + t.percent + '%' : '') + (t.absolute ? Number(t.absolute).toFixed(2) + 'U' : ''));
    ...
    if (options.insulindistribution) {
      ...
      $('<tr><td><b>' + translate('Carb ratio AM:') + '</b></td><td align="right">' + (carbRatios[0].totCarb/carbRatios[0].totBolus).toFixed(1) + 'U</td></tr>').appendTo(table);
      $('<tr><td><b>' + translate('Carb ratio PM:') + '</b></td><td align="right">' + (carbRatios[1].totCarb/carbRatios[1].totBolus).toFixed(1) + 'U</td></tr>').appendTo(table);
