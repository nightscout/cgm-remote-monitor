...
//        text = sign + '    ' + client.profilefunctions.profileSwitchName(treatment.cutting) + '    ' + '►►►' + '    ' + client.profilefunctions.profileSwitchName(treatment.profile) + '    ' + sign;
        text = sign + '►' + client.profilefunctions.profileSwitchName(treatment.cutting).substr(0,13) + sign;
      } else {
//        text = sign + '    ' + client.profilefunctions.profileSwitchName(treatment.profile) + '    ' + sign;
//        text = sign + ' ' + client.profilefunctions.profileSwitchName(treatment.profile) + sign;
        text = sign + '▬' + client.profilefunctions.profileSwitchName(treatment.profile).substr(0,13) + sign;
      }
      context.append('text')
        .style('font-size', 15)
//        .style('font-weight', 'bold')
