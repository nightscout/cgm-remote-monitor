...
calibrations.css =
  '#calibrations-list, #calibrations-chart {' +
  '  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif;' +
  '}' +
  '#calibrations-chart svg {' +
  '  font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif;' +
  '  background: #ffffff;' +
  ...
  '}' +
  '#calibrations-chart svg text {' +
  '  fill: #607d8b;' +
  '}' +
  '#calibrations-chart svg rect, #calibrations-chart svg circle, #calibrations-chart svg line {' +
...
calibrations.report = function report_calibrations (datastorage, sorteddaystoshow) {
  ...
  var colors = ['#4e79a7', '#f28e2b', '#59a14f', '#e15759', '#76b7b2', '#edc948', '#b07aa1', '#ff9da7', '#9c755f', '#bab0ac', '#86bcb6', '#d37295'];
  var colorindex = 0;
  var html = '<table>';
  var lastmbg = null;
