...
loopalyzer.html = function html(client) {
  ...
  var ret =
    ...
    + '<input type="checkbox" id="rp_loopalyzertreatments" checked><span style="color:blue;opacity:0.5">'+translate('Show bolus &amp; carb treatments')+'</span>'
    + '<br/><br/>'
...
loopalyzer.report = function report_loopalyzer(datastorage,sorteddaystoshow,options) {
  ...
  cobBin.forEach(entry => {

  });
//  console.log('cobBin', cobBin);
//  console.log('cobAvg', cobAvg);
