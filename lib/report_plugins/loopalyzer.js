...
loopalyzer.html = function html(client) {
  ...
  var ret = ''
    ...
    ret += 'Basal color: <input type="text" id="basalcolor" size="10" value="#33a0ff">'
    ret += 'Insulin color: <input type="text" id="insulincolor" size="10" value="#ff8000">'
...
loopalyzer.report = function report_loopalyzer(datastorage,sorteddaystoshow,options) {
  ...
  var basalColor = $('#basalcolor').val(); // '#33a0ff';
  var glucoseColor = '#33AA33';
  var glucoseRangeColor = '#D6FFD6';
  var insulinColor = $('#insulincolor').val(); // '#ff8000';
  console.log('BASAL   COLOR ' + basalColor);
  console.log('INSULIN COLOR ' + insulinColor);
  
  var carbColor = '#23d820'; //'#66CC66';
