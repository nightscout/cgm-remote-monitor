...
loopalyzer.getCOBs = function(datastorage, daysToShow, profile, client) {
  ...
  // Create a bins array with date entries for entire today
  var bins=[];
  ...
  daysToShow.forEach(function(day, dayIndex) {
    ...
    // cobs array are now 288 values, one per 5 minute, with COBs. Map them into the bins array.
    console.log('COBS', cobs);
    for (var i=0; i<288; i++) {
