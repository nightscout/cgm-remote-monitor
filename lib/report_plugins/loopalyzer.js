...
loopalyzer.html = function html(client) {
  ...
  var ret =
    ...
    + '</select>'
    + '<br>'
    + '<div id="loopalyzer-charts" style="height:500px;">'
    + '  <div class="chart" id="loopalyzer-chart"></div>'
    + '</div>'
    ;
    return ret;
};
...
loopalyzer.report = function report_loopalyzer(datastorage,sorteddaystoshow,options) {
  ...
  var chartOptions = {
    ...
    yaxes: [{
      ...
      /* Second axis is temp basal profile */
      min: -2,
      max: 10,
      tickColor: '#0000FF',
      position: "right",
    }, {
      /* Third axis is basal profile - blue */
      min: 0,
      max: 10,
      tickColor: '#0099FF',
      position: "right",
  ...
  $.plot( '#loopalyzer-chart', chartData, chartOptions );
