...
loopalyzer.getIOBs = function(datastorage, sorteddaystoshow) {
  ...
  // We re-sort the sorteddaystoshow in ascending order to make it easier to fill in the blank NaNs later
  var days = sorteddaystoshow.sort(function(a,b) {return a>b});

  // Create a single array of empty IOB entries to hold all IOBs for all days, one entry per 5 minutes
  var iobs=[];
  var numberOfEntries = 288 * days.length;
