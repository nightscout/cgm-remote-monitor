...
loopalyzer.getBasals = function(datastorage, daysToShow, profile) {
  ...
  daysToShow.forEach(function(day, dayIndex) {
    ...
    console.log('getBasals ' + day, basals);
...
loopalyzer.getTempBasalDeltas = function(datastorage, daysToShow, profile) {
  ...
  daysToShow.forEach(function(day, dayIndex) {
    ...
    console.log('getTempBasalDeltas ' + day, temps);
...
loopalyzer.getIOBs = function(datastorage, daysToShow, profile, client) {
  ...
  console.log('getIOBs iobStatusAvailable=' + iobStatusAvailable);
  ...
  daysToShow.forEach(function(day, dayIndex) {
    ...
    if (iobStatusAvailable) {
      ...
      console.log('getIOBs iobArray', iobArray);
      ...
      for (var dt=dayStart; dt < dayEnd; dt.add(5, 'minutes')) {
        ...
        iobs.push(iob);
        console.log('getIOBs ' + dt.format() + '  iob=' + iob);
      }
    }
...
loopalyzer.getCOBs = function(datastorage, daysToShow, profile, client) {
  ...
  console.log('getCOBs cobStatusAvailable=' + cobStatusAvailable);
  ...
  daysToShow.forEach(function(day, dayIndex) {
    ...
    if (cobStatusAvailable) {
      ...
      console.log('getCOBs cobArray', cobArray);
      ...
      for (var dt=dayStart; dt < dayEnd; dt.add(5, 'minutes')) {
        ...
        cobs.push(cob);
        console.log('getCOBs ' + dt.format() + '  cob=' + cob);
      }
    }
