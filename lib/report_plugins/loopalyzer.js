...
loopalyzer.report = function report_loopalyzer(datastorage,sorteddaystoshow,options) {
  ...
  var chartBasalOptions = {
    ...
    yaxis: {
      ...
      tickFormatter: function(val,axis) {
        console.log('BASAL: val=' + val + ', axis.min=' + axis.min + '  ' + (val - axis.min) + ', axis.max=' + axis.max + '  ' + (val - axis.max));
        if (val <= axis.min) { console.log('BLANKING MIN'); return ''; }
        if (val >= axis.max) { console.log('BLANKING MAX'); return ''; }
        return val + '';
      }
    },
    grid: {
    ...
    var chartBGOptions = {
      ...
      yaxis: {
        ...
        labelWidth: labelWidth,
        tickFormatter: function(val,axis) {
          console.log('BG: val=' + val + ', axis.min=' + axis.min + '  ' + (val - axis.min) + ', axis.max=' + axis.max + '  ' + (val - axis.max));
          if (val <= axis.min) { console.log('BLANKING MIN'); return ''; }
          if (val >= axis.max) { console.log('BLANKING MAX'); return ''; }
          return val + '';
        }
  ...
  var chartTempBasalOptions = {
    ...
    yaxis: {
      ...
      labelWidth: labelWidth,
      tickFormatter: function(val,axis) {
        console.log('TEMP: val=' + val + ', axis.min=' + axis.min + '  ' + (val - axis.min) + ', axis.max=' + axis.max + '  ' + (val - axis.max));
        if (val <= axis.min) { console.log('BLANKING MIN'); return ''; }
        if (val >= axis.max) { console.log('BLANKING MAX'); return ''; }
        return val + '';
      }
  ...
  var chartIOBOptions = {
    ...
    yaxis: {
      ...
      labelWidth: labelWidth,
      tickFormatter: function(val,axis) {
        console.log('IOB: val=' + val + ', axis.min=' + axis.min + '  ' + (val - axis.min) + ', axis.max=' + axis.max + '  ' + (val - axis.max));
        if (val <= axis.min) { console.log('BLANKING MIN'); return ''; }
        if (val >= axis.max) { console.log('BLANKING MAX'); return ''; }
        return val + '';
      }
    ...
    var chartCOBOptions = {
      ...
      yaxis: {
        ...
        labelWidth: labelWidth,
        tickFormatter: function(val,axis) {
          console.log('COB: val=' + val + ', axis.min=' + axis.min + '  ' + (val - axis.min) + ', axis.max=' + axis.max + '  ' + (val - axis.max));
          if (val <= axis.min) { console.log('BLANKING MIN'); return ''; }
          if (val >= axis.max) { console.log('BLANKING MAX'); return ''; }
          return val + '';
        }
  ...
  delete xaxisCfg.font; // Remove the font config so HH:MM is shown on the bottom chart
