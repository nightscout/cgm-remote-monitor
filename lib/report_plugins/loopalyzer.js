...
loopalyzer.html = function html(client) {
  ...
  var ret = ''
    ...
    ret += '<span id="loopalyzer-help"><b>' + translate('Depending on which uploader you use, how frequent it is able to capture your data and upload, and how it backfills missing data some graphs may be missing data. Always ensure the graphs look reasonable (best is to view one day at a time first to see).<br/><br/><br/>To see this report, press SHOW while in this view') + '</b></span>'
