...
loopalyzer.getIOBs = function(datastorage, daysToShow) {
  ...
  // If no IOB available return empty array
  if (!client.plugins('iob').isDeviceStatusAvailable(datastorage.devicestatus)) 
    return [];
...
loopalyzer.getCOBs = function(datastorage, daysToShow) {
  ...
  // If no COB available return empty array
  if (!client.plugins('cob').isDeviceStatusAvailable(datastorage.devicestatus)) 
    return [];
