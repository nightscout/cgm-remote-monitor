...
weektoweek.report = function report_weektoweek(datastorage,sorteddaystoshow,options) {
  ...
  weekstoshow.forEach( function eachWeek(week) {
    ...
    week.forEach( function eachDay(day) {
      ...
      console.log('First sgv: ' + datastorage[day].sgv[0].date + ' last sgv: ' + datastorage[day].sgv[datastorage[day].sgv.length].date);
      ...
      console.log('First sgv: ' + sgvData[0].date + ' last sgv: ' + sgvData[sgvData.length].date);
