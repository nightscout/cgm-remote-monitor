...
weektoweek.report = function report_weektoweek(datastorage, sorteddaystoshow, options) {
  ...
  if (sorteddaystoshow[0] > sorteddaystoshow[sorteddaystoshow.length - 1]) {
    reset_day = moment(sorteddaystoshow[sorteddaystoshow.length - 1]).day() - 1;
    if (reset_day < 0) {
      reset_day += 7;
    }
  } else {
