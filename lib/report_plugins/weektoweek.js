...
weektoweek.prepareHtml = function weektoweekPrepareHtml(sortedweekstoshow) {
  $('#weektoweekcharts').html('');
  sortedweekstoshow.forEach(function eachWeek(d) {
    $('#weektoweekcharts').append($('<table><tr><td><div id="weektoweekchart-' + d + '"></div></td><td><div id="weektoweekstatchart-' + d + '"></td></tr></table>'));
  });
};
