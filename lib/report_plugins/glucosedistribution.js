...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  var preg2 = parseFloat(result.Up.readingspct) + parseFloat(preg1);
  ...
  var tar2Pct = parseFloat(tar2).toFixed(1);
  var tar3Pct = parseFloat(tar3).toFixed(1);
  var tar4Pct = parseFloat(tar4).toFixed(1);
  var preg1Pct = parseFloat(preg1).toFixed(1);
  var preg2Pct = parseFloat(preg2).toFixed(1);
  var preg3Pct = parseFloat(preg3).toFixed(1);
  var titrPct = parseFloat(titr).toFixed(1);
  var tirPct = parseFloat(tir).toFixed(1);
  var tbr1Pct = parseFloat(tbr1).toFixed(1);
  var tbr2Pct = parseFloat(tbr2).toFixed(1);
  var tbr3Pct = parseFloat(tbr3).toFixed(1);
  ...
  ['SuperHigh', 'High', 'Elevated', 'Up', 'Normal', 'Lowish', 'Low', 'SuperLow'].forEach(function(range) {
    ...
    if (topline) {
      if (tar3count > 1) {
        $('<td class="tdborder" rowspan="' + tar3count + '" colspan="' + (1-custom) + '"><br/>' + tar3Pct + '%</td>').appendTo(tr);
      } else if (haveBelow && !noGravid && normalcols == 1) {
        $('<td></td>').appendTo(tr);
      }
      if (tar2count > 1) {
        $('<td class="tdborder" rowspan="' + tar2count + '"><br/>' + tar2Pct + '%</td>').appendTo(tr);
      } else if (!custom) {
        $('<td></td>').appendTo(tr);
      }
      ...
      if (extra) {
        if (tar4count > 1) {
          $('<td class="tdborder" rowspan="' + tar4count + '">' + tar4Pct + '%</td>').appendTo(tr);
        } else {
          $('<td></td>').appendTo(tr);
        }
      }
    ...
    if (range == 'High' && !custom && !noGravid && preg3count > 0) {
      $('<td class="tdborder" rowspan="' + preg3count + '">' + preg3Pct + '%</td>').appendTo(tr);
    }
    ...
    if (range == 'Elevated') {
      ...
      if (tircount > 1) {
        if (elevRange == 2) {
          $('<td class="tdborder" style="background-color:' + tablecolors['Elevated'] + '" rowspan="' + tircount + '">' + translate('TITR') + '<br/><strong>' + tirPct + '%</strong></td>').appendTo(tr);
        } else if (elevRange == 3) {
          $('<td class="tdborder" style="background-color:' + tablecolors['Elevated'] + '" rowspan="' + tircount + '">' + translate('TIR') + '<br/><strong>' + tirPct + '%</strong></td>').appendTo(tr);
        } else {
          $('<td class="tdborder" rowspan="' + tircount + '">' + tirPct + '%</td>').appendTo(tr);
        }
      } else {
        $('<td></td>').appendTo(tr);
      }
    ...
    if (range == 'Up') {
      ...
      if (titrcount > 1) {
        if (upRange == 2) {
          $('<td class="tdborder" style="background-color:' + tablecolors['Up'] + '" rowspan="' + titrcount + '">' + translate('TITR') + '<br/><strong>' + titrPct + '%</strong></td>').appendTo(tr);
        } else if (upRange == 3) {
          $('<td class="tdborder" style="background-color:' + tablecolors['Up'] + '" rowspan="' + titrcount + '">' + translate('TIR') + '<br/><strong>' + titrPct + '%</strong></td>').appendTo(tr);
        } else {
          $('<td class="tdborder" rowspan="' + titrcount + '">' + titrPct + '%</td>').appendTo(tr);
        }
      } else {
        $('<td></td>').appendTo(tr);
      }
      $('<td class="tdborder" style="background-color:' + tablecolors['Lowish'] + '" rowspan="3">' + translate('TING') + '<br/><strong>' + preg2Pct + '%</strong></td>').appendTo(tr);
    }
    ...
    if (range == 'Normal') {
      ...
      if (extra) {
        $('<td class="tdborder" rowspan="2">' + preg1Pct + '%</td>').appendTo(tr);
      }
      if (custom) {
    ...
    if (range == 'Lowish') {
      $('<td class="tdborder">' + r.readingspct + '%</td>').appendTo(tr);
      if (tbr2count > 1) {
        $('<td class="tdborder" rowspan="' + tbr2count + '"><br/><strong>' + tbr2Pct + '%</strong></td>').appendTo(tr);
      } else if (haveAbove) {
        $('<td></td>').appendTo(tr);
      }
      if (!custom && tbr3count > 1) {
        if (!noGravid) {
          $('<td class="tdborder" rowspan="' + tbr3count + '">' + tbr3Pct + '%</td>').appendTo(tr);
        } else {
          $('<td></td>').appendTo(tr);
        }
    ...
    if (range == 'Low') {
      $('<td class="tdborder">' + r.readingspct + '%</td>').appendTo(tr);
      if (tbr1count > 1) {
        $('<td class="tdborder" colspan="' + (1+extra) + '" rowspan="' + tbr1count + '"><br/><strong>' + tbr1Pct + '%</strong></td>').appendTo(tr);
      } else if (haveAbove) {
