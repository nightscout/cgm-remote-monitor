...
glucosedistribution.report = function report_glucosedistribution(datastorage,sorteddaystoshow,options) {
  ...
  report.append(table);
   ...
   $('<tr><th>Mean Absolute Change</th><th>Time in fluctuation<br>(>5 mg/dl/5m)</th><th>Time in rapid fluctuation<br>(>10 mg/dl/5m)</th></tr>').appendTo(stabilitytable);
   ...
   var mac = Math.round(total / data.length).toFixed(1);
