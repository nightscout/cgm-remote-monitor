...
glucosedistribution.html = function html(client) {
    ...
    var ret =
        ...
        '* ' + translate('The A1C estimate is only a rough estimation that can be very inaccurate and does not replace actual blood testing. The formula used is taken from:') +
