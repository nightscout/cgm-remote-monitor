...
function init ( ) {
  ...
  settings.DEFAULT_FEATURES = ['delta', 'direction', 'timeago', 'upbat', 'errorcodes', 'profile'];
  ...
  function adjustShownPlugins ( ) {
    ...
    ['iob', 'cob', 'bwp', 'cage', 'basal', 'careportal' , 'boluscalc'].forEach( function showFeature (feature) {
