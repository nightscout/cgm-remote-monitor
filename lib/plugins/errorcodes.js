...
function init() {
  ...
  var code2Level = {
    5: 0 //notifications.levels.INFO
    , 9: 2 //notifications.levels.URGENT
    , 10: 2 //notifications.levels.URGENT
  };
  ...
  errorcodes.checkNotifications = function checkNotifications (sbx) {
    ...
    if (lastSGV && now - lastSGV.mills < TIME_10_MINS_MS && lastSGV.mgdl < 39) {
      ...
      var notifyLevel = code2Level[lastSGV.mgdl] || sbx.notifications.levels.LOW;
