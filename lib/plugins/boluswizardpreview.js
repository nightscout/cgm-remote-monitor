...
function init() {
  ...
  function hasRequiredInfo (sbx) {
    ...
    if (!sbx.data.profile.target_high || !sbx.data.profile.target_low) {
      console.warn('For the BolusWizardPreview plugin to function your treatment profile must have both target_high and target_low fields');
      return false;
    }
