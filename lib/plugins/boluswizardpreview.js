...
function init (ctx) {
  ...
  /**
   * @typedef {object} BWPNotificationSettings
   * @property {number} snoozeBWP
   * @property {number} warnBWP
   * @property {number} urgentBWP
   * @property {number} snoozeLength
   */

  /**
   * @typedef {object} BWPResult
   * @property {number} effect
   * @property {number} outcome
   * @property {number} bolusEstimate
   * @property {number} [scaledSGV]
   * @property {string[]} [errors]
   * @property {object} [iobData]
   * @property {number} [iob]
   * @property {object} [recentCarbs]
   * @property {number} [aimTarget]
   * @property {string} [aimTargetString]
   * @property {boolean} [belowLowTarget]
   * @property {object} [tempBasalAdjustment]
   * @property {number} [tempBasalAdjustment.thirtymin]
   * @property {number} [tempBasalAdjustment.onehour]
   * @property {string} bolusEstimateDisplay
   * @property {string} outcomeDisplay
   * @property {string} displayIOB
   * @property {string} effectDisplay
  ...
  bwp.checkNotifications = function checkNotifications (sbx) {
    ...
    // Ensure prop exists and there are no errors, or errors array is empty
    if (!prop || (prop.errors && prop.errors.length > 0)) { return; }
  ...
  function pushInfo(prop, info, sbx) {
    if (prop && prop.errors) {
      ...
      prop.errors?.forEach(function pushError (error) {
