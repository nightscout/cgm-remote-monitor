...
function init() {
  ...
  upbat.analyzeData = function analyzeData (sbx) {
    ...
    if (min && min.uploader) {
      ...
      result.notification = min.uploader.notification;
  ...
  upbat.checkNotifications = function checkNotifications(sbx) {
    ...
    if (prop.notification && prop.notification >= levels.WARN) {
      ...
      sbx.notifications.requestNotify({
        level: prop.notification
        , title: levels.toDisplay(prop.notification) + ' Uploader Battery is Low'
        , message: message
        , pushoverSound: 'echo'
  ...
  upbat.updateVisualisation = function updateVisualisation (sbx) {
    ...
    sbx.pluginBase.updatePillText(upbat, {
      ...
      , pillClass: prop && levels.toStatusClass(prop.notification)
      , info: infos
