...
function init(ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
    	...
    	reasonconf.push({ name: translate('Activity'), targetTop: 7, targetBottom: 7, duration: 120 });
    } else {
    	reasonconf.push({ name: translate('Eating Soon'), targetTop: 80, targetBottom: 80, duration: 60 });
    	reasonconf.push({ name: translate('Activity'), targetTop: 126, targetBottom: 126, duration: 120 });   
    }
