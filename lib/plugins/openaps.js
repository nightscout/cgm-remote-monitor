...
function init(ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
	...
	reasonconf.push({ name: translate('Biking Trainer'), targetTop: 8, targetBottom: 8, duration: 90 });
	...
	reasonconf.push({ name: translate('Biking Trainer'), targetTop: 140, targetBottom: 140, duration: 90 });
