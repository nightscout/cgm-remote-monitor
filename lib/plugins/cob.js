...
function init(ctx) {
  ...
  cob.googleHome = {
    intentHandlers: [{
      ...
      , routableSlot: 'metric'
      , slots: ['cob', 'carbs on board', 'carbs']
      , intentHandler: googleHomeCOBIntentHandler
    }]
  };
