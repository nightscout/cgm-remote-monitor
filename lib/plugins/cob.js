...
function init(ctx) {
  ...
  cob.isDeviceStatusAvailable = function lastCOBDeviceStatus (devicestatus) {
  ...
  cob.COBDeviceStatusesInTimeRange = function lastCOBDeviceStatus (devicestatus, from, to) {
