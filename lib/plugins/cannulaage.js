...
function init() {
  ...
  cage.updateVisualisation = function updateVisualisation() {
    ...
    this.updatePillText(age + 'h', 'CAGE', [{label: 'Inserted:', value: moment(treatmentDate).format('lll')}, {label: 'Notes:', value: message}]);
