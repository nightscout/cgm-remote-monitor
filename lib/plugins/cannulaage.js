...
cage.checkNotifications = function checkNotifications(sbx) {
  ...
  console.log(prefs.enableAlerts, cannulaInfo.checkForAlert);
  ...
  if (cannulaInfo.age === prefs.info) { sendNotification = true; }
  if (cannulaInfo.age === prefs.warn) { sendNotification = true; msg = ', time to change'; }
  if (cannulaInfo.age === prefs.urgent) { sendNotification = true; msg = ', change overdue!'; sound = 'persistent'; level = 2;}
