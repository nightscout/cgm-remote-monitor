...
cage.checkNotifications = function checkNotifications(sbx) {
  ...
  if (!sbx.extendedSettings.enablealerts || !cannulaInfo.checkForAlert) { return; }
  ...
  if (cannulaInfo.age === info) { sendNotification = true; }
  if (cannulaInfo.age === warn) { sendNotification = true; msg = ', time to change'; }
  if (cannulaInfo.age === urgent) { sendNotification = true; msg = ', change overdue!'; sound = 'persistent'; }
