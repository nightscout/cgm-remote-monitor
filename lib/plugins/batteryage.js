...
function init(ctx) {
    ...
    bage.getPrefs = function getPrefs(sbx) {
        ...
        info: sbx.extendedSettings.info || 312
            ...
            , urgent: sbx.extendedSettings.urgent || 3600
    ...
    bage.findLatestTimeChange = function findLatestTimeChange(sbx) {
        ...
        if (prefs.display === 'days' && batteryInfo.found) {
            ...
            if (prefs.display === 'days') {
                batteryInfo.display = batteryInfo.found ? batteryInfo.age + 'h' : 'n/a:d'+prefs.display;
            } else {
                batteryInfo.display = batteryInfo.found ? batteryInfo.age + 'h' : 'n/a:found ';
            }
        }
