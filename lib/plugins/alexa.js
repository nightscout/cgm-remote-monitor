...
function init (env, ctx) {
  ...
  alexa.getIntentHandler = function getIntentHandler(intentName, metric) {
    if (metric === undefined) {
      ...
      if (intentName
        && intentHandlers[String(intentName)]
        && intentHandlers[String(intentName)].handler
      ) {
        console.log('Found!');
      ...
      if (intentName
        && intentHandlers[String(intentName)]
        && intentHandlers[String(intentName)][String(metric)]
        && intentHandlers[String(intentName)][String(metric)].handler
      ) {
        console.log('Found!');
