...
function init(ctx) {
  ...
  loop.updateVisualisation = function updateVisualisation (sbx) {
	...
	var eventualBGscaled = sbx.settings.units === 'mmol' ? sbx.roundBGToDisplayFormat(sbx.scaleMgdl(eventualBG)) : eventualBG;
        var maxBGscaled = sbx.settings.units === 'mmol' ? sbx.roundBGToDisplayFormat(sbx.scaleMgdl(maxBG)) : maxBG;
        var minBGscaled = sbx.settings.units === 'mmol' ? sbx.roundBGToDisplayFormat(sbx.scaleMgdl(minBG)) : minBG;
        valueParts = valueParts.concat([
