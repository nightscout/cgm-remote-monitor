...
function init (env, authorization) {
  ...
  endpoints.get('/permissions', authorization.isPermitted('authorization:permissions:read'), function getSubjects (req, res) {
    res.json(authorization.seenPermissions);
  });

  endpoints.get('/permissions/trie', authorization.isPermitted('authorization:permissions:read'), function getSubjects (req, res) {
  ...
  endpoints.post('/subjects', authorization.isPermitted('authorization:subjects:create'), function createSubject (req, res) {
  ...
  endpoints.put('/subjects', authorization.isPermitted('authorization:subjects:update'), function saveSubject (req, res) {
  ...
  endpoints.delete('/subjects/:_id', authorization.isPermitted('authorization:subjects:delete'), function deleteSubject (req, res) {
  ...
  endpoints.post('/roles', authorization.isPermitted('authorization:roles:create'), function createSubject (req, res) {
  ...
  endpoints.put('/roles', authorization.isPermitted('authorization:roles:update'), function saveRole (req, res) {
  ...
  endpoints.delete('/roles/:_id', authorization.isPermitted('authorization:roles:delete'), function deleteRole (req, res) {
