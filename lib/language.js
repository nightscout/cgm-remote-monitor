...
function init() {
  ...
  var translations = {
    ...
    ,'Colorblind-friendly colors' : {
      cs: 'Pro barvoslepé'
      ,he: 'צבעים ידידותיים לעיוורי צבעים'
    ...
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,he: 'פקודה זו מוחקת את כל המסמכים מאוסף "devicestatus". שימושי כאשר סוללת מכשיר ההעלאה לא מתעדכנת כראוי.'
      }
    ...
    ,'Each role will have a 1 or more permissions.  The <em>*</em> permission is a wildcard, permissions are a hierarchy using <em>:</em> as a separator.' : {
      ...
      ,he: 'לכל תפקיד יהיה לפחות אישור 1. אישור ה<em>*</em> משמש כ"קלף חופשי", אישורים הם היררכיה בשימוש <em>:</em> כמפריד.'
    }
    ,'Add new Role' : {
   ...
   ,'Last Carbs' : {
    ...
    'alexaNoInsulin': {
      ...
      'alexaLastLoop': {
        ...
        , he: 'הרצת הלולאה האחרונה הייתה ב %1'
      },
    ...
    'alexaLoopForecast': {
      ...
      , he: 'על פי הלולאה סוכרכם יהיה %1 בעוד %2'
    },
    ...
    'TDD average': {
      ...
      , he: 'צריכת אינסולין יומית ממוצעת'
    },
    'Carbs average': {
