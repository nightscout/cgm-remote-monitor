  ...
  var translations = {
   ...
   ,'Last Carbs' : {
    ...
    'alexaForecastUnavailable': {
      ...
      ,el: 'Η πρόβλεψη δεν είναι δυνατή με τα υπάρχοντα δεδομένα'
    ...
    'alexaOpenAPSForecast': {
      ...
      ,el: 'Η προβλεπόμενη τιμή σακχάρου (OpenAPS) είναι'
    ...
    'Last entry {0} minutes ago': {
      ...
      ,el: 'Τελευαία δεδομένα {0} λεπτά πριν'
    ...
    'Last data received': {
      ...
      ,el: 'Τελευταία δεδομένα ελήφθησαν'
