  ...
  var translations = {
   ...
   ,'Last Carbs' : {
    ...
    , 'Mean Total Daily Change' : {
      ...
      ,tr: 'Toplam günlük ortalama değişim'
    }
    , 'Mean Hourly Change' : {
      ...
      ,tr: 'Saat başına ortalama değişim'
    }
      , 'FortyFiveDown': {
    ...
    'Carbs average': {
      ...
      , tr: 'Günlük ortalama karbonhidrat'
    },
    'Eating Soon': {
      cs: 'Blížící se jídlo'
      , fi: 'Ruokailu pian'
    ...
    'Protein average': {
      ...
      tr: 'Günlük ortalama protein'  //Are those averages for daily averages?  
    },
    'Fat average': {
      fi: 'Rasva keskiarvo'
      tr: 'Günlük ortalama yağ'
    },
    'Total carbs': {
