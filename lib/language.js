...
// food editor
    ,'Using stored API secret hash' : {
      ...
      ,pl: 'Kożystajac z zapisanego poufnego API'
      }
    ...
    ,'Store hash on this computer (Use only on private computers)' : {
      ...
      ,pl: 'Zapisane na tym komputerze (Kożystaj tylko na komputerach prywatnych)'
      }
    ,'Treatments' : {
      cs: 'Ošetření'
      ,de: 'Bearbeitung'
    ...
    ,'BG from CGM (autoupdated)' : {
      ...
      ,pl: 'Wartość BG brana z CGM (automatycznie)'
      }
    ,'BG from meter' : {
    ...
    ,'Entering record failed' : {
      ...
      ,nb: 'Lagring feilet'
      ,pl: 'Wprowadzenie rekordu nie udało się'
      }
    ...
    ,'Urgent High Alarm' : {
      ...
      ,he: 'התראת גבוה דחופה'
      ,pl: 'Uwaga: Wysoki poziom glikemi'
      }
    ,'High Alarm' : {
      cs: 'Vysoká glykémie'
      ,de: 'Hoch Alarm'
    ...
    ,'All sensor events' : {
      ...
      ,pl: 'Wszystkie zdarzenia dt sensora'
      }
    ,'Remove future items from mongo database' : {
      ...
      ,pl: 'Usuń przyszle wpisy z bazy mongo'
      }
    ,'Find and remove treatments in the future' : {
      ...
      ,pl: 'Znajdź i usuń leczenie w przyszosci'
      }
    ,'This task find and remove treatments in the future.' : {
      ...
      ,pl: 'To zadanie znajduje i usuwa leczenie w przyszlosci"'
      }
    ,'Remove treatments in the future' : {
      ...
      ,pl: 'Usuń leczenie w przyszlosci'
      }
    ,'Find and remove entries in the future' : {
      ...
      ,pl: 'Znajdz i usuń wpisy w przyszlosci'
      }
    ,'This task find and remove CGM data in the future created by uploader with wrong date/time.' : {
      ...
      ,pl: 'To zadanie odnajduje i usuwa dane CGM w przyszlosci utworzone przez uploader ze zla data/czasem.'
      }
    ...
    ,'Database contains %1 future records' : {
      ...
      ,pl: 'Baza danych zawiera %1 przyszlych rekordów'
      }
    ...
    ,'Error loading database' : {
      ...
      ,pl: 'Blad wczytywania bazy danych'
      }
    ,'Record %1 removed ...' : {
    ...
    ,'Error removing record %1' : {
      ...
      ,pl: 'Blad przy usuwaniu rekordu %1'
      }
    ,'Deleting records ...' : {
    ...
    ,'Clean Mongo status database' : {
      ...
      ,pl: 'Oczysc status bazy danych Mongo'
      }
    ,'Delete all documents from devicestatus collection' : {
      ...
      ,pl: 'Wykasuj wszystkie dokumenty z kolekcji devicestatus'
      }
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,pl: 'To zadanie usuwa wszystkie dokumenty z kolekcji devicestatus. Jest potrzebne kiedy stan ladowania baterii uploadera nie jest aktualizowany'
      }
