 ...
    , { code: 'zh_tw', language: '中文（繁體）' }
  ...
  var translations = {
    ...
    ,'Your API secret must be at least 12 characters long' : {
      ...
      ,es: 'Su API secreto debe contener al menos 12 caracteres'
    ...
    ,'Use COB correction in calculation' : {
      ...
      ,es: 'Usar carbohidratos activos para el cálculo'
    ...
    ,'Carbs needed if Insulin total is negative value' : {
      ...
      ,es: 'Carbohidratos necesarios si el total insulina es un valor negativo'
    ...
    ,'Device not authenticated' : {
      ...
      ,es: 'Dispositivo no autentificado'
    ...
    ,'Drag&drop food here' : {
      ...
      ,es: 'Arrastra y suelta comida aquí'
    ...
    ,'This task find and remove CGM data in the future created by uploader with wrong date/time.' : {
      ...
      ,es: 'Este comando encuentra y elimina datos del sensor futuros creados por actualizaciones con errores fecha/hora.'
    ...
    ,'Remove %1 selected records?' : {
      ...
      ,es: 'Elimina %1 registros seleccionados?'
    ...
    ,'Error loading database' : {
      ...
      ,es: 'Error cargando base de datos'
    ...
    ,'Clean Mongo status database' : {
      ...
      ,es: 'Limpiar la base de datos de estado Mongo' 
    ...
    ,'Delete all documents from devicestatus collection' : {
      ...
      ,es: 'Eliminar todos los documentos de la colección devicestatus'
    ...
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,es: 'Esta tarea elimina todos los documentos de la colección dedevicestatus. Útil cuando el estado de la batería cargadora no se actualiza correctamente'
    ...
    ,'Delete all documents' : {
      ...
      ,es: 'Borrar totos los documentos'
    ...
    ,'Delete all documents from devicestatus collection devicestatus?' : {
      ...
      ,es: 'Borrar todos los documentos de la colección devicestatus?'
    ...
    ,'Database contains %1 records' : {
      ...
      ,es: 'Base de datos contiene %1 registros'
    ...
    ,'Loading temp basal data' : {
      ...
      ,es: 'Cargando datos temporales tasa basal'
    ...
    ,'Save current record before changing to new?' : {
      ...
      ,es: 'Grabar datos actuales antes cambiar por nuevos?'
