...
// food editor
    ...
    ,'Your device is not authenticated yet' : {
      ...
      ,nl: 'Uw apparaat is nog niet geautheticeerd'
      }
    ,'Sensor' : {
      cs: 'Senzor'
      ,de: 'Sensor'
    ...
    ,'Insulin-on-Board' : {
      ...
      ,nl: 'Actieve insuline in lichaam (IOB)'
      }
    ,'Carbs-on-Board' : {
      cs: 'COB' 
      ...
      ,nl: 'Actieve koolhydraten in lichaam (COB)'
      }
