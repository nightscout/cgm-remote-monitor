...
// food editor
    ...
    ,'Loading OpenAPS data of' : {
      ...
      ,ko: 'OpenAPS 로딩'
      ,it: 'Caricando i dati OpenAPS di'
      }
    ,'Loading profile switch data' : {
      ...
      ,ko: '프로파일 변환 데이터 로딩'
      ,it: 'Caricando i dati di cambio profilo'
      }
    ...
    ,'Each role will have a 1 or more permissions.  The <em>*</em> permission is a wildcard, permissions are a hierarchy using <em>:</em> as a seperator.' : {
