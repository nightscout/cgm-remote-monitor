...
function init() {
  ...
  var translations = {
    ...
    ,'No API secret hash stored yet. You need to enter API secret.' : {
      ...
      ,hu: 'Még nem lett titkos API hash elmentve. Add meg a titkos API jelszót'
      }
    ,'Database loaded' : {
      cs: 'Databáze načtena'
    ...
    ,'Remember this device. (Do not enable this on public computers.)' : {
      ...
      ,hu: 'A berendezés megjegyzése. (Csak saját berendezésen használdÖ'
      }
    ,'Treatments' : {
      cs: 'Ošetření'
      ,de: 'Behandlungen'
    ...
    ,'Additional Notes, Comments' : {
      ...
      ,zh_cn: '备注'
      ,hu: 'További jegyzetek, hozzászólások'
      }
    ,'RETRO MODE' : {
      cs: 'V MINULOSTI'
      ,he: 'מצב רטרו'
    ...
    ,'Pump Battery change overdue!' : {  // batteryage.js
      ...
      ,hu:  'A pump eleme cserére szorul'
    }
    ...
    ,'Error removing record %1' : {
      ...
      ,zh_cn: '%1条记录清除出错'
      ,zh_tw: '%1條記錄清除出錯'
      ,hu: 'Hiba lépett fel a %1 bejegyzések törlése közben'
      }
    ,'Deleting records ...' : {
    ...
    ,'Clean Mongo status database' : {
      ...
      ,zh_cn: '清除状态数据库'
      ,hu: 'Mongo állapot adatbázis tisztítása'
      }
    ...
    ,'Delete all documents from devicestatus collection older than 30 days' : {
      ...
      , hu: 'Az összes "devicestatus" dokumentum törlése ami 3ö napnál öregebb'
      }
    ...
    ,'This task removes all documents from entries collection that are older than 180 days. Useful when uploader battery status is not properly updated.' : {
      ...
      ,hu: 'A feladat kitürli az összes bejegyzésekből álló dokumentumot ami 180 napnál öregebb. Hasznos ha a feltöltő elem állapota nem jelenik meg helyesen.'
      }
    ...
    ,'Delete all documents from treatments collection older than 180 days' : {
      ...
      ,hu: 'Töröld az összes 18ö napnál öregebb kezelési dokumentumot'
      }
    ...
    ,'Loading temp basal data' : {
      ...
      ,zh_cn: '载入临时基础率数据'
      ,hu: 'Az étmeneti bazal adatainak betöltése'
      }
    ...
    ,'General profile settings' : {
      ...
      ,zh_cn: '通用配置文件设置'
      ,hu: 'Általános prfil beállítások'
      }
    ,'Title' : {
      cs: 'Název'
      ,he: 'כותרת '
    ...
    ,'Represents the typical duration over which insulin takes effect.  Varies per patient and per insulin type. Typically 3-4 hours for most pumped insulin and most patients. Sometimes also called insulin lifetime.' : {
      ...
      ,hu: 'Kimutatja hogy átlalában meddig ha az inzulin. Változó különböző pácienseknél és inzulinoknál. Általában 3-4 óra között mozog. Néha inzulin élettartalomnak is nevezik.'
      }
    ...
    ,'g carbs per U insulin. The ratio of how many grams of carbohydrates are offset by each U of insulin.' : {
      ...
      ,hu: 'g szénhidrát per U inzulin. Az arány, hogy hány gramm szénhidrát fel le bizonyos egységnyi inzulint'
      }
    ,'Insulin Sensitivity Factor (ISF)' : {
      ...
      ,zh_cn: '胰岛素敏感系数（ISF）'
      ,hu: 'Inzulin Érzékenység Faktor (ISF)'
      }
    ...
    ,'Target BG range [mg/dL,mmol/L]' : {
      ...
      ,hu: 'BG terjedés célpontja [mg/dL,mmol/L]'
      }
    ...
    ,'Positive temp basal insulin:' : {
      ...
      ,zh_cn: '实际临时基础率胰岛素'
      ,hu: 'Pozitív átmeneti bazal inzulin'
      }
    ,'Negative temp basal insulin:' : {
      ...
      ,zh_cn: '其余临时基础率胰岛素'
      ,hu: 'Negatív átmeneti bazal inzulin'
      }
    ,'Total basal insulin:' : {
    ...
    ,'Unable to delete Subject' : {
      ...
      ,hu: 'A személyet nem sikerült törölni'
    }
   ...
   ,'Last Carbs' : {
    ...
    ,'To see this report, press SHOW while in this view' : {
      ...
      ,hu: 'A jelentés megjelenítéséhez kattints a megjelenítés gombra'
    }
    ,'AR2 Forecast' : {
      cs: 'AR2 predikci'
      ,he: 'AR2 תחזית '
    ...
    , 'Mean Hourly Change is a sum of the absolute value of all glucose excursions for the examined period, divided by the number of hours in the period. Lower is better.' : {
      ...
      ,tr: 'Az átlagos óránkénti változás az abszút értékek összege elosztva a napok számával. A kisebb érték jobb ebben az esetben.'
    }
    , 'GVI (Glycemic Variability Index) and PGS (Patient Glycemic Status) are measures developed by Dexcom, detailed <a href="' : {
     ...
     ,hu: 'GVI (Glycemic Variability Index) and PGS (Patient Glycemic Status) a dexcom cég által fejlesztett mérések, részletekért kövesd a linket <a href="'
    }
    , '">can be found here</a>.' : {
     cs: '">zde</a>.'
     ,he: '">here</a>.'
    ...
    'virtAsstBasalTemp': {
        ...
        , hu:  '%1 átmeneti bazál %2 egység üránként ami %3 -kor jár le'
    },
    'virtAsstIob': {
    ...
    'Database size is %1 MiB out of %2 MiB. Please backup and clean up database!': {
      ...
      ,nl: 'Az adatbázis mérete %1 MiB a rendelkezésre álló %2 MiB-ból. Készítsen biztonsági másolatot!'
    },
    'Database file size': {
    ...
    'virtAsstDatabaseSize': {
      ...
      ,nl: '%1 MiB ami %2% a rendelkezésre álló méretből'
    },
