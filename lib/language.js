...
function init() {
  ...
  var translations = {
    ...
    ,'Target bg range bottom' : {
      ...
      ,pl: 'Docelowy dolny zakres glikemii'
...
// ported reporting
    ...
    ,'There is not sufficient data to run this report. Select more days.' : {
      ...
      ,pl: 'Brak wystarczającej ilości danych aby sporządzić raport. Wybierz więcej dni.'
...
// food editor
    ,'Using stored API secret hash' : {
      ...
      ,pl: 'Używam zapisanego poufnego hasha API'
    ...
    ,'No API secret hash stored yet. You need to enter API secret.' : {
      ...
      ,pl: 'Nie zapisano poufnego hasha API. Należy wprowadzić poufne API.'
    ...
    ,'Error: Database failed to load' : {
      ...
      ,pl: 'Błąd: Nie udało się załadować bazy'
    ...
    ,'Your API secret must be at least 12 characters long' : {
      ...
      ,pl: 'Twoje poufne API musi składać się z przynajmniej 12 znaków'
    ...
    ,'Please verify that the data entered is correct' : {
      ...
      ,pl: 'Proszę zweryfikować czy wprowadzone dane są prawidłowe'
    ...
    ,'Use carbs correction in calculation' : {
      ...
      ,pl: 'Używaj poprawki cukrów w obliczeniach'
    ...
    ,'Use COB correction in calculation' : {
      ...
      ,pl: 'Użyj korekcji COB w obliczeniach'
    ...
    ,'Enter insulin correction in treatment' : {
      ...
      ,pl: 'Wprowadź korektę insulinową w zabiegach'
    ...
    ,'Entering record failed' : {
      ...
      ,pl: 'Błąd podczas wprowadzania rekordu'
    ...
    ,'Insulin Cartridge Change' : {
      ...
      ,pl: 'Wymiana pojemnika z insuliną'
    ...
    ,'When enabled an alarm may sound.' : {
      ...
      ,pl: 'Sygnalizacja dźwiękowa przy włączonym alarmie'
    ...
    ,'Urgent High Alarm' : {
      ...
      ,pl: 'Uwaga: Wysoki poziom glikemii'
    ...
    ,'Urgent Low Alarm' : {
      ...
      ,pl: 'Uwaga: Niski poziom glikemii'
    ...
    ,'Stale Data: Urgent' : {
      ...
      ,pl: 'Ostrzeżenie: dane nieaktualne'
    ...
    ,'When enabled the page will be dimmed from 10pm - 6am.' : {
      ...
      ,pl: 'Po włączeniu, strona będzie przyciemniona pomiędzy 22 wieczorem a 6 rano'
    ...
    ,'When enabled small white dots will be displayed for raw BG data' : {
      ...
      ,pl: 'Po włączeniu, małe białe kropki będą widoczne dla surowych (RAW) danych BG'
    ...
    ,'Reset, and use defaults' : {
      ...
      ,pl: 'Zresetuj i użyj wartości domyślnych'
    ...
    ,'Remove future items from mongo database' : {
      ...
      ,pl: 'Usuń przyszłe pozycje z bazy mongo'
      }
    ,'Find and remove treatments in the future' : {
      ...
      ,pl: 'Znajdź i usuń zabiegi w przyszłości'
      }
    ,'This task find and remove treatments in the future.' : {
      ...
      ,pl: 'To zadanie znajduje i usuwa zabiegi w przyszłości'
      }
    ...
    ,'This task find and remove CGM data in the future created by uploader with wrong date/time.' : {
      ...
      ,pl: 'To zadanie znajduje i usuwa dane CGM w przyszłości utworzone przez uploader ze złą datą/czasem.'
      }
    ...
    ,'Database contains %1 future records' : {
      ...
      ,pl: 'Baza zawiera %1 przyszłych rekordów'
      }
    ,'Remove %1 selected records?' : {
      ...
      ,pl: 'Usunąc %1 wybranych rekordów?'
      }
    ...
    ,'Error removing record %1' : {
      ...
      ,pl: 'Błąd podczas usuwania rekordu %1'
      }
    ,'Deleting records ...' : {
    ...
    ,'Clean Mongo status database' : {
      ...
      ,pl: 'Czyszczenie bazy Mongo status'
      }
    ,'Delete all documents from devicestatus collection' : {
      ...
      ,pl: 'Usunąć wszystkie dokumenty z kolekcji devicestatus'
      }
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,pl: 'To zadanie usuwa wszystkie dokumenty z kolekcji devicestatus. Przydatne gdy status baterii uploadera nie jest prawidłowo zaktualizowany.'
      }
    ...
    ,'Temp Basal Start' : {
      ...
      ,pl: 'Początek tymczasowego Basal'
      }
    ,'Temp Basal End' : {
    ...
    ,'Loading temp basal data' : {		
      ...
      ,pl: 'Ładowanie danych tymczasowych dawek'
      }
