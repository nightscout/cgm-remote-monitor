...
function init() {
  ...
  var translations = {
    ...
    ,'Loading food database' : {
      ...
      ,pl: 'Ładowanie bazy danych pożywienia'
...
// food editor
    ,'Using stored API secret hash' : {
      ...
      ,pl: 'Używam zapisanego sekretnego hasha API'
    ...
    ,'No API secret hash stored yet. You need to enter API secret.' : {
      ...
      ,pl: 'Nie zapisano sekretnego hasha API. Musisz wprowadzić sekret API.'
    ...
    ,'Your API secret must be at least 12 characters long' : {
      ...
      ,pl: 'Twój sekret API musi mieć przynajmniej 12 znaków'
    ...
    ,'Please verify that the data entered is correct' : {
      ...
      ,pl: 'Proszę zweryfikować prawidłowość wprowadzonych danych'
    ...
    ,'Use BG correction in calculation' : {
      ...
      ,pl: 'Używaj korekcji glikemii przy kalkulacji'
    ...
    ,'BG from CGM (autoupdated)' : {
      ...
      ,pl: 'Glikemia z CGM (autoaktualizacja)'
    ...
    ,'Use carbs correction in calculation' : {
      ...
      ,pl: 'Używaj poprawki cukrów w kalkulacji'
    ...
    ,'Use COB correction in calculation' : {
      ...
      ,pl: 'Użyj korekcji COB w kalkulacji'
    ...
    ,'Enter insulin correction in treatment' : {
      ...
      ,pl: 'Wprowadź korektę insulinową w leczeniu'
    ...
    ,'Carbs needed if Insulin total is negative value' : {
      ...
      ,pl: 'Brakuje węglowodanów jeśli wynik jest ujemny'
    ...
    ,'Additional Notes, Comments' : {
      ...
      ,pl: 'Dodatkowe notatki, komentarze'
    ...
    ,'Add food from your database' : {
      ...
      ,pl: 'Dodaj pożywienie z Twojej bazy'
    ...
    ,'When enabled an alarm may sound.' : {
      ...
      ,pl: 'Gdy włączone możliwy słyszalny alarm.'
    ...
    ,'When enabled the page will be dimmed from 10pm - 6am.' : {
      ...
      ,pl: 'Gdy włączony, strona będzie przyciemniona pomiędzy 22 a 6 rano'
    ...
    ,'Show Raw BG Data' : {
      ...
      ,pl: 'Pokaż surowe (RAW) dane glikemii'
    ...
    ,'When enabled small white dots will be displayed for raw BG data' : {
      ...
      ,pl: 'Gdy włączone, małe białe kropki będą widoczne dla danych surowych (RAW) glikemii'
    ...
    ,'Find and remove treatments in the future' : {
      ...
      ,pl: 'Znajdź i usuń leczenia w przyszłości'
      }
    ,'This task find and remove treatments in the future.' : {
      ...
      ,pl: 'To zadanie znajduje i usuwa leczenia w przyszłości'
      }
    ,'Remove treatments in the future' : {
      ...
      ,pl: 'Usuń leczenia w przyszłości'
      }
    ...
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,pl: 'To zadanie usuwa wszystkie dokumenty z kolekcji devicestatus. Użyteczne gdy status baterii uploadera nie jest prawidłowo zaktualizowany.'
      }
