...
// food editor
    ...
    ,'Drag&drop food here' : {
      ...
      ,de: 'Mahlzeit hierher verschieben (Drag&Drop)'
    ...
    ,'Remove %1 selected records?' : {
      ...
      ,de: 'Ausgewählten %1 Eintrag löschen?'
    ...
    ,'Delete all documents from devicestatus collection' : {
      ...
      ,de: 'Lösche alle Dokumente von Gerätestatus-Collection (devicestatus)'
    ...
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,de: 'Diese Aufgabe entfernt alle Dokumente aus der Gerätestatus-Collection (devicestatus). Nützlich wenn der Uploader-Batteriestatus sich nicht richtig aktualisiert.'
    ...
    ,de: 'Entferne alle Dokumente der Gerätestatus-Collection (devicestatus)?'
    ...
    ,'Temp Basal Start' : {
      ...
      ,de: 'Start der temporären Basalrate'
    ...
    ,'Temp Basal End' : {
      ...
      ,it: 'Fine Basale Temp'
      ,de: 'Ende der temporären Basalrate'
    ...
    ,'Save current record before changing to new?' : {
      ...
      ,de: 'Aktuelle Einträge vor dem Wechsel zu einem Neuem speichern?'
    ...
    ,'Represents the typical duration over which insulin takes effect.  Varies per patient and per insulin type. Typically 3-4 hours for most pumped insulin and most patients. Sometimes also called insulin lifetime.' : {
      ...
      ,de: 'Entspricht der typischen Dauer die das Insulin wirkt. Variiert je Patient und Insulintyp. Häufig 3-4 Stunden für die meisten Pumpeninsuline und die meisten Patienten. Manchmal auch Insulin-Wirkungsdauer genannt.'
    ...
    ,'Insulin to carb ratio (I:C)' : {
      ...
      ,nb: 'IKH forhold'
      ,de: 'Insulin/Kohlenhydrate-Verhältnis (I:C)'
    ...
    ,'mg/dL or mmol/L per U insulin. The ratio of how much BG changes with each U of corrective insulin.' : {
      ...
      ,de: 'mg/dL oder mmol/L pro Einheit Insulin. Verhältnis von Blutzuckeränderung je Einheit Korrekturinsulin.'
    ...
    ,'Time ranges of target_low and target_high don\'t  match. Values are restored to defaults.' : {
      ...
      ,de: 'Zeitspanne vom untersten und obersten Wert werden nicht berücksichtigt. Werte auf Standard hergestellt.'
