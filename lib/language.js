...
// food editor
    ...
    ,'When enabled an alarm may sound.' : {
      ...
      ,it: 'Attiverai gli allarmi acustici.'
      }
    ,'Urgent High Alarm' : {
      ...
      ,it: 'Urgente:Glicemia Molto Alta'
      }
    ,'High Alarm' : {
      cs: 'Vysoká glykémie'
      ,de: 'Hoch Alarm'
    ...
    ,'When enabled the page will be dimmed from 10pm - 6am.' : {
      ...
      ,it: 'Attivandola, la pagina sarà oscurata dalle 22:00 alle 06:00.'
      }
    ,'Enable' : {
      cs: 'Povoleno'
      ,de: 'Eingeschaltet'
    ...
    ,'When enabled small white dots will be displayed for raw BG data' : {
      ...
      ,it: 'Quando lo abiliti, visualizzerai piccoli puntini bianchi cioè i dati grezzi'
      }
    ,'Custom Title' : {
