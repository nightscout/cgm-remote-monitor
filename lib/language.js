...
// food editor
    ...
    ,'Time ranges of target_low and target_high don\'t  match. Values are restored to defaults.' : {
      ...
      ,sv: 'Tidsintervall för målområde högt/lågt stämmer inge. Använder standardvärden'
      }
    ,'Valid from:' : {
      cs: 'Platné od:'
      ,de: 'Gültig von:'
    ...
    ,'Change treatment time to %1 ?' : {
      ...
      ,sv: 'Ändra tiden för behandling till%1 ?'
      }
    ,'Change carbs time to %1 ?' : {
      ...
      ,sv: 'Ändra tiden för kolhydrater till %1 ?'
      }
    ,'Change insulin time to %1 ?' : {
      ...
      ,sv: 'Ändra tiden för insulin till %1 ?'
      }
    ,'Remove treatment ?' : {
