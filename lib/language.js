...
// food editor
    ...
    ,'Database contains %1 future records' : {
      ...
      ,nl: 'Database bevat %1 toekomstige gegevens'
      }
    ,'Remove %1 selected records?' : {
      ...
      ,nl: 'Verwijder %1 geselecteerde gegevens?'
      }
    ...
    ,'Error removing record %1' : {
      ...
      ,nl: 'Fout bij het verwijderen van %1 invoer'
      }
    ,'Deleting records ...' : {
    ...
    ,'Clean Mongo status database' : {
      ...
      ,nl: 'Schoon Mongo status database op'
      }
    ,'Delete all documents from devicestatus collection' : {
      ...
      ,nl: 'Alle Records verwijderen uit de collectie "status van het apparaat"'
      }
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,nl: 'Deze taak verwijdert alle records uit de collectie "Apparaatstatus". Dit is handig wanneer de batterij niet correct wordt weergegeven.'
      }
    ...
    ,nl: 'Verwijder alle records van de collectie "Device Status"?'
      }
    ...
    ,'Database records' : {
      ...
      ,sk: 'Záznamy databázi'
      ,nl: 'Vermeldingen in de database'
      }
    ,'Add new record' : {
    ...
    ,'Represents the typical duration over which insulin takes effect.  Varies per patient and per insulin type. Typically 3-4 hours for most pumped insulin and most patients. Sometimes also called insulin lifetime.' : {
      ...
      ,nl: 'Geeft de werkingsduur van de insuline in het lichaam aan. Dit verschilt van patient tot patient en per soort insuline, algemeen gemiddelde is 3 tot 4 uur. '
      }
    ...
    ,'g carbs per U insulin. The ratio of how many grams of carbohydrates are offset by each U of insulin.' : {
      ...
      ,nl: 'gram koolhydraten per eenheid insuline. De verhouding geeft aan hoeveel insuline per koolhydraten nodig is.'
      }
    ...
    ,'grams per unit time. Represents both the change in COB per unit of time, as well as the amount of carbs that should take effect over that time.  Carb absorption / activity curves are less well understood than insulin activity, but can be approximated using an initial delay followed by a constant rate of absorption (g/hr).' : {
      ...
      ,nl: 'Gram per tijdseenheid. : Zowel de verandering in COB per tijdseenheid, en de hoeveelheid koolhydraten die moet werken via deze tijd. Koolhydraat absorptie / activiteit curves zijn minder duidelijk dan insulineactiviteit, maar ze kunnen worden benaderd met een initiële vertraging constant verbruik (g / hr.)'
      }
    ...
    ,'Calculation is in target range.' : {
      ...
      ,nl: 'Berekening valt binnen doelwaarde'
      }
    ...
    ,'Time ranges of target_low and target_high don\'t  match. Values are restored to defaults.' : {
      ...
      ,nl: 'Periode vanaf de laagste en de hoogste waarde wordt genegeerd. Waarden terugzetten op standaard.' 
      }
    ,'Valid from:' : {
      cs: 'Platné od:'
      ,de: 'Gültig ab:'
    ...
    ,'When enabled icon to start edit mode is visible' : {
      ...
      ,nl: 'Als het icoon geactiveerd is bewerkingsmodus beschikbaar'
      }
    ,'Operation' : {
      cs: 'Operace'
      ,ro: 'Operațiune'
    ...
    ,'Loading profile switch data' : {
      ...
      ,nl: 'Laden gewijzigde profiel gegevens'
      }
    ,'Profile is going to be saved in newer format used in Nightscout 0.9.0 and above and will not be usable in older versions anymore.\nAre you sure?' : {
      ...
      ,nl: 'rofiel wordt opgeslagen in een nieuw formaat voor NightScout 0.9.0 en hoger, en is niet meer in oudere versies beschikbaar. Weet je het zeker?'
      }
    ,'Wrong profile setting.\nNo profile defined to displayed time.\nRedirecting to profile editor to create new profile.' : {
      ...
      ,nl: 'Verkeerde profiel instelling. \nDe tijd is niet gedefineerd \n Ga terug naar het profiel en pas het aan.'
      }
    ,'Pump' : {
      cs: 'Pumpa'
      ,sk: 'Pumpa'
