 ...
    , { code: 'zh_tw', language: '中文（繁體）' }
  ...
  var translations = {
    ...
    ,'Loading food database' : {
      ...
      ,fr: 'Chargement base données aliments'
    ...
    ,'There is not sufficient data to run this report. Select more days.' : {
      ...
      ,fr: 'Pas assez de données pour ce rapport. Sélectionnez plus de jours.'
    ...
    ,'Error: Database failed to load' : {
      ...
      ,fr: 'Erreur: chargement base de données a échoué'
    ...
    ,'Please verify that the data entered is correct' : {
      ...
      ,fr: 'Merci de vérifier la validité des données entrées'
    ...
    ,'Carbs needed if Insulin total is negative value' : {
      ...
      ,fr: 'Glucides nécessaires si insuline totale est négative'
    ...
    ,'Reset, and use defaults' : {
      ...
      ,fr: 'Remettre valeurs par défaut'
