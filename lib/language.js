...
function init() {
  ...
  var translations = {
    ...
    ,'Please verify that the data entered is correct' : {
      ...
      ,ru: 'Подтвердите правильность вводимых данных'
    ...
    ,'Use carbs correction in calculation' : {
      ...
      ,ru: 'Пользоваться коррекцией ГУ при расчете'
    ...
    ,'Enter insulin correction in treatment' : {
      ...
      ,ru: 'Внести коррекцию инсулина в терапию'
    ...
    ,'When enabled an alarm may sound.' : {
      ...
      ,ru: 'При активации может сработать оповещение'
    ...
    ,'Remove future items from mongo database' : {
      ...
      ,ru: 'Удалить будущие данные из базы'
    ...
    ,'Clean Mongo status database' : {
      ...
      ,ru: 'Очистить статус базы данных'
    ...
    ,'Clean Mongo entries (glucose entries) database' : {
      ...
      ,ru: 'Очистить записи данных в базе'
    ...
    ,'Clone this record to new' : {
      ...
      ,ru: 'Клонировать эту запись в новую'
    ...
    ,'Insulin Sensitivity Factor (ISF)' : {
      ...
      ,ru: 'Множитель чувствительности к инсулину ISF'
    ...
    ,'When enabled icon to start edit mode is visible' : {
      ...
      ,ru: 'При активации видна пиктограмма начала режима редактирования'
    ...
    ,'Snoozing high alarm since there is enough IOB' : {
      ...
      ,ru: 'Отключение оповещения о высокой ГК ввиду достаточности инсулина в организме'
    ...
    ,'Excess insulin equivalent %1U more than needed to reach low target, not accounting for carbs' : {
      ...
      ,ru: 'Избыток инсулина равного %1U, необходимого для достижения нижнего целевого значения, углеводы не учтены'
    ...
    ,'%1U reduction needed in active insulin to reach low target, too much basal?' : {
      ...
      ,ru: 'Для достижения нижнего целевого значения необходимо понизить величину активного инсулина на %1U, чрезмерна база?'
    ...
    ,'Basal reduction to account %1 units:' : {
      ...
      ,ru: 'Снижение базы для компенсации %1 единиц'
    ...
    ,'Cannula change overdue!' : {
      ...
      ,ru: 'Срок замены катетера помпы пропущен!'
   ...
   ,'Last Carbs' : {
    ...
    , 'Out of Range RMS is calculated by squaring the distance out of range for all glucose readings for the examined period, summing them, dividing by the count and taking the square root. This metric is similar to in-range percentage but weights readings far out of range higher. Lower values are better.' : {
      ...
      ,ru: 'Вне диапазона RMS рассчитывается возведением в квадрат дистанции вне диапазона всех ГК периода , суммированием их, делением на количество и извлечением квадратного корня. This metric is similar to in-range percentage but weights readings far out of range higher. Lower values are better.'
