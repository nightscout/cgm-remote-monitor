...
// food editor
    ...
    ,'Find and remove entries in the future' : {
      ...
      ,ro: 'Caută și șterge valori din viitor'
      }
    ,'This task find and remove CGM data in the future created by uploader with wrong date/time.' : {
      ...
      ,ro: 'Instrument de căutare și eliminare a datelor viitoare, create de uploader cu oră setată incorect.'
      }
    ...
    ,'Clean Mongo status database' : {
      ...
      ,ro: 'Curăță tabela despre status din baza de date'
