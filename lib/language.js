...
function init() {
  ...
  var translations = {
    ...
    ,'Loading food database' : {   
      ...
      ,бг: 'Зареждане на данни за храни'
      }
    ,'not displayed' : {   
      cs: 'není zobrazeno'
      ,de: 'nicht angezeigt'
    ...
    ,'Loading treatments data of' : {   
      ...
      ,бг: 'Зареждане на данни за леченията от'
      }
    ,'Processing data of' : {   
      cs: 'Zpracovávám data'
...
// ported reporting
    ...
    ,'There is not sufficient data to run this report. Select more days.' : {   
      ...
      ,бг: 'Няма достатъчно данни за показване. Изберете повече дни'
	  }
// food editor
    ,'Using stored API secret hash' : {   
      ...
      ,бг: 'Използване на запаметена API парола'
      }
    ,'No API secret hash stored yet. You need to enter API secret.' : {   
      ...
      ,бг: 'Няма запаметена АPI парола. Моля въведете API парола'
      }
    ,'Database loaded' : {   
      cs: 'Databáze načtena'
    ...
    ,'Error: Database failed to load' : {   
      ...
      ,бг: 'Грепка. Базата с данни не успя да се зареди'
      }
    ,'Create new record' : {   
    ...
    ,'Your API secret must be at least 12 characters long' : {   
      ...
      ,бг: 'Вашата API парола трябва да е дълга поне 12 символа'
      }
    ,'Bad API secret' : {   
      cs: 'Chybné API heslo'
