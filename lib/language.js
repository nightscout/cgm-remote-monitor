...
// food editor
    ...
    ,'Please verify that the data entered is correct' : {
      ...
      ,ro: 'Verificați corectitudinea datelor introduse'
    ...
    ,'BG from CGM (autoupdated)' : {
      ...
      ,ro: 'Glicemie din senzor (automat)'
    ...
    ,'Use COB correction in calculation' : {
      ...
      ,ro: 'Folosește corecție COB în calcule'
    ...
    ,'When enabled the page will be dimmed from 10pm - 6am.' : {
      ...
      ,ro: 'La activare va scădea iluminarea ecranului între 22 și 6'
    ...
    ,'When enabled small white dots will be displayed for raw BG data' : {
      ...
      ,ro: 'La activare vor apărea, pe grafic, puncte albe reprezentând citirea brută a glicemiei'
