...
// food editor
    ...
    ,'Drag&drop food here' : {
      ...
      ,it: 'Trascina e rilascia del cibo qui'
      }
    ,'Care Portal' : {
      cs: 'Portál ošetření'
      ,sv: 'Care Portal'
    ...
    ,'Target BG range [mg/dL,mmol/L]' : {
      ...
      ,it: 'Obbiettivo d\'intervallo glicemico [mg/dL,mmol/L]'
      }
    ...
    ,'Time ranges of target_low and target_high don\'t  match. Values are restored to defaults.' : {
      ...
      ,it: 'Intervalli di tempo della glicemia obbiettivo inferiore e superiore non corretti. Valori ripristinati a quelli standard.'
      }
    ,'Valid from:' : {
      cs: 'Platné od:'
      ,de: 'Gültig ab:'
    ...
    ,'Change carbs time to %1 ?' : {
      ...
      ,it: 'Cambiare tempo carboidrati ad %1 ?'
      }
    ,'Change insulin time to %1 ?' : {
      ...
      ,it: 'Cambiare tempo insulina ad %1 ?'
      }
    ,'Remove treatment ?' : {
    ...
    ,'Remove insulin from treatment ?' : {
      ...
      ,ko: '처리에서 인슐린을 지우세요.'
      ,it: 'Rimuovere insulina dal trattamento ?'
      }
    ,'Remove carbs from treatment ?' : {
      ...
      ,ko: '처리에서 탄수화물을 지우세요.'
      ,it: 'Rimuovere carboidrati dal trattamento ?'
      }
    ,'Rendering' : {
      cs: 'Vykresluji'
      ,ro: 'Se desenează'
    ...
    ,'Loading OpenAPS data of' : {
      ...
      ,ko: 'OpenAPS 로딩'
      ,it: 'Caricando dati di OpenAPS di'
      }
    ,'Loading profile switch data' : {
      ...
      ,ko: '프로파일 변환 데이터 로딩'
      ,it: 'Caricamento dati cambio profilo'
      }
    ...
    ,'admin, school, family, etc' : {
      ...
      ,bg: 'администратор,училище,семейство'
    ...
    ,'BWP' : { // Bolus Wizard Preview
      ...
      ,pt: 'Ajuda de bolus'
      ,sk: 'BK'
      ,bg: 'Предварителна Болусна калкулация '
    }
    ,'Urgent' : {
      cs:'Urgentní'
      ,ro: 'Urgent'
    ...
    ,'Snoozing high alarm since there is enough IOB' : {
      ...
      ,bg: 'Игнориране на алармата за високи стойности при наличие на достатъчно инсулин в организма(IOB)'
    }
    ,'Check BG, time to bolus?' : {
      ...
      ,bg: 'Проверка КЗ,време е за болус?'
    }
    ,'Notice' : {
      cs:'Poznámka'
      ,ro: 'Notificare'
    ...
    ,'Excess insulin equivalent %1U more than needed to reach low target, not accounting for carbs' : {
      ...
      ,bg: 'Излишен инсулин равен на %1U повече от колкото е необходимо за достигане на ниската цел,не се отчита за въглехидрати'
    }
    ,'Excess insulin equivalent %1U more than needed to reach low target, MAKE SURE IOB IS COVERED BY CARBS' : {
      ...
      ,bg: 'Излишен инсулин равен на %1U повече от колкото е необходимо за достигане на ниската цел,убедете се че активния инсулин(IOB)е покрит от въглехидрати'
    }
    ,'%1U reduction needed in active insulin to reach low target, too much basal?' : {
      ...
      ,bg: '%1U намаление е необходимо на активния инсулинза достигане на ниската цел,прекалено много базал?'
    }
    ,'basal adjustment out of range, give carbs?' : {
      ...
      ,bg: 'корекция на базала извън нормите,добавяне въглехидрати?'
    }
    ,'basal adjustment out of range, give bolus?' : {
      ...
      ,bg: 'корекция на базала извън нормите,добавяне болус?'
    }
    ,'above high' : {
      cs:'nad horním'
    ...
    ,'Check BG using glucometer before correcting!' : {
      ...
      ,bg: 'Провери КЗ с глюкомер преди корекция'
    }
    ,'Basal reduction to account %1 units:' : {
      ...
      ,bg: 'намаление на базала за компенсиране %1 единици '
    }
    ,'30m temp basal' : {
    ...
    ,'Cannula change overdue!' : {
      ...
      ,bg: 'Времето за смяна на сет е пресрочено'
    }
   ...
   ,'Last Carbs' : {
    ...
    ,'Insulin reservoir change overdue!' : {
      ...
      ,bg: 'Смяната на резервоара е пресрочена'
    }
    ,'Time to change insulin reservoir' : {
      ...
      ,bg: 'Време е за смяна на резервоар'
    }
    ,'Change insulin reservoir soon' : {
      ...
      ,bg: 'Наближажа смяна на резервоар'
    }
    ...
    ,'Stale data, check rig?' : {
      ...
      ,ru: 'Устаревшие данные, проверьте устройства'
      ...
      ,bg: 'Остарели данни,провери уплоудъра'
    }
    ,'Last received:' : {
      cs:'Naposledy přijato:'
      ,ro: 'Ultimile date:'
      ,ru: 'Предыдущее полученное значение'
      ,sv: 'Senast mottagen:'
      ,nb: 'Sist mottatt:'
    ...
    ,'Sensor change/restart overdue!' : {
      ...
      ,ru: 'Просрочено время замены/перезапуска сенсора'
    ...
    ,'Sensor age %1 days %2 hours' : {
      ...
      ,bg: 'Възраст на сензора %1 дни %2 часове'
    }
    ,'Sensor Insert' : {
      cs: 'Výměna sensoru'
