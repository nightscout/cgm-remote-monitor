...
// food editor
   ...
   ,'Last Carbs' : {
    ...
    'FortyFiveDown': {
        en: ' and slightly dropping',
        de: ' und leicht sinkend'
    },
    'FortyFiveUp': {
        en: ' and slightly rising',
        de: ' und leicht fallend'
    },
    'Flat': {
        en: ' and holding',
        de: ' und gleichbleibend'
    },
    'SingleUp': {
        en: ' and rising',
        de: ' und steigend'
    ...
    'DoubleDown': {
        en: ' and rapidly dropping',
        de: ' und schnell sinkend'
    },
    'DoubleUp': {
        en: ' and rapidly rising',
        de: ' und schnell steigend'
    },
    'alexaStatus': {
        en: '${sgv} ${direction} as of ${time}.',
        de: '${sgv} ${direction} bis ${time}.'
    },
    'alexaBasal': {
        en: '${preamble} current basal is ${basal} units per hour',
        de: '${preamble} aktuelle Basalrate ist ${basal} Einheiten je Stunde'
    },
    'alexaBasalTemp': {
        en: '${preamble} temp basal of ${basal} units per hour will end ${left}',
        de: '${preamble} temporäre Basalrate von ${basal} Einheiten endet in ${left}'
    },
    'alexaIob': {
        en: 'and you have ${iob} units of insulin on board.',
        de: 'und du hast noch ${iob} Einheiten Insulin Restwirkung.'
    },
    'alexaPreamble': {
        en: 'Your',
        de: 'Deine'
...
language.translatePlaceholders = function translatePlaceholders(textKey, vars) {
    var text = language.translate(textKey);
    for (var key in vars) {
        var term = '${' + key + '}';
        text = text.replace(term, vars[key]);
    };
    return text;
};
