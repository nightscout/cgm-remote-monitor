...
function init() {
  ...
  var translations = {
    ...
    ,'Loading treatments data of' : {
      ...
      ,it: 'Carico trattamenti dati del'
...
// food editor
    ...
    ,'IAGE Insulin Age' : {
      ...
      ,it: 'IAGE-Cambio Cartuccia Insulina'
    ...
    ,'Save current record before changing to new?' : {
      ...
      ,it: 'Salva record corrente prima di passare al nuovo?'
      }
    ,'Profile Switch' : {
      cs: 'Přepnutí profilu'
      ,ro: 'Schimbă profilul'
    ...
    ,'Clone this record to new' : {
      ...
      ,it: 'Clonare questo record come nuovo'
      }
    ,'Record valid from' : {
      cs: 'Záznam platný od'
    ...
    ,'Duration of Insulin Activity (DIA)' : {
      ...
      ,it: 'Durata d\'Azione Insulina (DAI)'
      }
    ,'Represents the typical duration over which insulin takes effect.  Varies per patient and per insulin type. Typically 3-4 hours for most pumped insulin and most patients. Sometimes also called insulin lifetime.' : {
      ...
      ,it: 'Rappresenta la tipica duranta di funzionamento dell\'insulina. E 'diverso in ogni paziente e per ogni tipologia d\'insulina. Tipicamente è di 3-4 ore.'
      }
    ,'Insulin to carb ratio (I:C)' : {
      ...
      ,it: 'Rapporto Insulina Carboidrato (I:C)'
      }
    ,'hours' : {
      cs: 'hodiny'
      ,ro: 'ore'
    ...
    ,'g carbs per U insulin. The ratio of how many grams of carbohydrates are offset by each U of insulin.' : {
      ...
      ,it: 'g carboidrati per U d\'insulina. Descrive quanti grammi di carboidrati devono essere gestiti da un\'unità d\'insulina.'
      }
    ,'Insulin Sensitivity Factor (ISF)' : {
      ...
      ,it: 'Fattore Sensibilità Insulinica (FSI)'
      }
    ,'mg/dL or mmol/L per U insulin. The ratio of how much BG changes with each U of corrective insulin.' : {
      ...
      ,it: 'mg/dL o mmol/L per U d\'insulina. Il rapporto tra la quantità di BG cambia con ogni U d\'insulina correttiva.'
      }
    ,'Carbs activity / absorption rate' : {
      ...
      ,it: 'Attività Carboidrati / tasso assorbimento'
      }
    ,'grams per unit time. Represents both the change in COB per unit of time, as well as the amount of carbs that should take effect over that time.  Carb absorption / activity curves are less well understood than insulin activity, but can be approximated using an initial delay followed by a constant rate of absorption (g/hr).' : {
      ...
      ,it: 'grammi per unità di tempo. Rappresenta sia la variazione COB per unità di tempo, così come la quantità di carboidrati che dovrebbe essere applicata durante quel tempo. Carb curve di assorbimento / attività sono meno conosciuti rispetto all\'attività dell\'insulina, ma possono essere approssimate con un ritardo iniziale seguito da un assorbimento costante (g/ora).'
      }
    ...
    ,'Target BG range [mg/dL,mmol/L]' : {
      ...
      ,it: 'Intervallo desiderato di glucosio nel sangue [mg/dL,mmol/L]'
      }
    ...
    ,'Calculation is in target range.' : {
      ...
      ,it: 'Il calcolo è nell\'intervallo di riferimento.'
      }
    ...
    ,'Error. Default values used.' : {
      ...
      ,it: 'Errore. Ripristinati i valori di default'
      }
    ,'Time ranges of target_low and target_high don\'t  match. Values are restored to defaults.' : {
      ...
      ,it: 'I livelli di glucosio nel sangue non corrispondono. I valori vengono ripristinati ai valori predefiniti.'
      }
    ,'Valid from:' : {
      cs: 'Platné od:'
      ,nb: 'Gyldig fra:'
    ...
    ,'Add new interval before' : {
      ...
      ,it: 'Aggiungere nuovo intervallo prima'
      }
    ,'Delete interval' : {
      cs: 'Smazat interval'
      ,nb: 'Slett intervall'
