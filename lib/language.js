...
<<<<<<< HEAD
      ,nl: 'Er is niet voldoende data voor dit rapport, selecteer ruimere periode'
	  }
=======
...
<<<<<<< HEAD
      ,nl: 'Er is nog geen HASH opgeslgen, voer eerste een API geheim in.'
=======
...
<<<<<<< HEAD
      ,nl: 'FOUT: Bij het laden van de database'
=======
...
<<<<<<< HEAD
      ,nl: 'De API code moet minimaal 12 karakters lang zijn'
=======
...
<<<<<<< HEAD
      ,nl: 'Sla API code op. (Gebruik alleen op prive computer) '
=======
...
<<<<<<< HEAD
      ,nl: 'Controleer of de ingevoerde waardes correct zijn'
...
<<<<<<< HEAD
      ,nl: 'Gebruik glucosewaarde in berekening'
=======
