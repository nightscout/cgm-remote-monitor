...
function init() {
  ...
  var translations = {
    ...
    ,'temp basals must be rendered to display this report': { //hourlystats.js
      ...
      ,he: 'חובה לאפשר רמה בזלית זמנית כדי לרות דוח זה'
      ,ru: 'Для этого отчета требуются данные о врем базалах'
    }
    ,'Weekly success' : {
   ...
   ,'Last Carbs' : {
    ...
    'alexaNoInsulin': {
      ...
      'alexaReservoir': {
        ...
        , ru: 'осталось %1 единиц в резервуаре'
      },
      'alexaPumpBattery': {
      ...
      'alexaLastLoop': {
        ...
        , ru: 'прошлый удавшийся цикл был %1'
      },
    'alexaLoopNotAvailable': {
      ...
      , ru: 'расширение ЗЦ Loop по-видимому неактивно'
    },
    'alexaLoopForecast': {
      ...
      , ru: 'по прогнозу цикла ожидается %1 в течение след. %2'
    },
    'alexaForecastUnavailable': {
      ...
      , ru: 'прогноз с этими данными невозможен'
    },
    'alexaRawBG': {
    en: 'Your raw bg is %1'
    ...
    'alexaOpenAPSForecast': {
      ...
      , ru: 'СК,прогнозируемый OpenAPS %1'
    },
    'alexaCOB': {
