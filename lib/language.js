...
function init() {
  ...
  var translations = {
    ...
    ,'Reset, and use defaults' : {
      ...
      ,tr: 'Ön ayarları sıfırla ve kullan' // Sıfırla ve varsayılanları kullan
      ,zh_cn: '使用默认值重置'
      ,zh_tw: '使用默認值重置'
      }
    ,'Calibrations' : {
    ...
    ,'Each subject will have a unique access token and 1 or more roles.  Click on the access token to open a new view with the selected subject, this secret link can then be shared.' : {
      ...
      ,tr: 'Her konu benzersiz bir erişim anahtarı ve bir veya daha fazla rol alır. Seçilen konuyla ilgili yeni bir görünüm elde etmek için erişim tuşuna tıklayın. Bu gizli bağlantı paylaşılabilir.'
    ...
    ,'BWP' : { // Bolus Wizard Preview
      ...
      ,zh_tw: 'BWP'
      ,pl: 'Kalkulator bolusa'
      ,tr: 'BWP Bolus Yardımı'  //Bolus Yardımı, Bolus hesaplayıcısı, Ön izleme Bolus Calculator, 
    }
    ,'Urgent' : {
      cs:'Urgentní'
      ,he: 'דחוף '
