  ...
  var translations = {
   ...
   ,'Last Carbs' : {
    ...
    'alexaNoInsulin': {
      ...
      'alexaUploadBattery': {
		  bg: 'Батерия на качващото устройство %1'
      ...
      'alexaReservoir': {
		  bg: 'Остават %1 единици в резервоара'
      ...
      'alexaPumpBattery': {
		bg: 'Батерията на помпата е на %1 %2'
      ...
      'alexaLastLoop': {
		bg: 'Последния успешен лууп беше в %1'
    ...
    'alexaLoopForecast': {
	  bg: 'Според прогнозата се очаква да сте %1 за следващите %2'
    ...
    'alexaForecastUnavailable': {
	  bg: 'Не може да се направи предположение от тези данни'
    ...
    'alexaOpenAPSForecast': {
      ...
      , fi: 'OpenAPS verensokeriarvio on %1'
		  ...
		  ,bg: 'Според OpenAPS евентуалната захар е %1'
    },
    'alexaCOB': {
