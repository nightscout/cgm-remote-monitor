...
const CONFIG = {
  testFile: 'tests/api.partial-failures.test.js',
  iterations: parseInt(process.env.FLAKY_ITERATIONS, 10) || 5,
  timeout: parseInt(process.env.FLAKY_TEST_TIMEOUT, 10) || 120000,
...
async function main() {
  console.log('Flaky Test Isolation Harness: api.partial-failures.test.js');
  console.log('='.repeat(50));
  console.log(`Iterations: ${CONFIG.iterations}`);
  console.log(`Timeout: ${CONFIG.timeout}ms`);
  console.log('Note: This test file takes longer to run');
  console.log('='.repeat(50));
  ...
  const reportPath = path.join(CONFIG.outputDir, 'partial-failures-isolation-results.json');
