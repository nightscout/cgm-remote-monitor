...
On Node 22.23.2 with isolated MongoDB 6.0.27, the refreshed sources passed a clean locked install, production/development builds, main tests (1,975 passing, three existing pending), client-core (283) and dependency tests (317). Final validation must include any subsequently merged modernization changes and green integration-target CI before merge.
