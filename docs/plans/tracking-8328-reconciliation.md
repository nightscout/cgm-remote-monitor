...
Snapshot: modernization integration `4a287bef`, 2026-09-06. GitHub still reports
...
#8692 is under CI review for per-service alarm ownership and teardown; it is not yet integrated and does not define live-cache capacity.
